...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_landscape = internal_1.element("rux-icon-crop-landscape");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_crop_landscape, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_crop_landscape, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_crop_landscape, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_crop_landscape);
            if (default_slot)
...
class RuxIconCropLandscape extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconCropLandscape;
//# sourceMappingURL=RuxIconCropLandscape.js.map