...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_battery_20 = internal_1.element("rux-icon-battery-20");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_battery_20, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_battery_20, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_battery_20, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_battery_20);
            if (default_slot)
...
class RuxIconBattery20 extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconBattery20;
//# sourceMappingURL=RuxIconBattery20.js.map