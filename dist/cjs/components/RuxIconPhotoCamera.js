...
function create_fragment(ctx) {
    let rux_icon_photo_camera;
    let current;
    const default_slot_template = /*#slots*/ ctx[5].default;
    const default_slot = internal_1.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
    return {
        c() {
            rux_icon_photo_camera = internal_1.element("rux-icon-photo-camera");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_photo_camera, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_photo_camera, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_photo_camera, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_photo_camera, null);
            }
            /*rux_icon_photo_camera_binding*/ ctx[6](rux_icon_photo_camera);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_photo_camera);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_photo_camera_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_photo_camera_binding($$value) {
    ...
    return [
        ...
        $$scope,
        slots,
        rux_icon_photo_camera_binding
    ];
}
class RuxIconPhotoCamera extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconPhotoCamera;
//# sourceMappingURL=RuxIconPhotoCamera.js.map