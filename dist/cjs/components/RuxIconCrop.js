...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop = internal_1.element("rux-icon-crop");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_crop, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_crop, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_crop, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_crop, null);
            }
            /*rux_icon_crop_binding*/ ctx[6](rux_icon_crop);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_crop);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_crop_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_crop_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_crop_binding];
}
class RuxIconCrop extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconCrop;
//# sourceMappingURL=RuxIconCrop.js.map