...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_bookmark_border = internal_1.element("rux-icon-bookmark-border");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_bookmark_border, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_bookmark_border, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_bookmark_border, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_bookmark_border);
            if (default_slot)
...
class RuxIconBookmarkBorder extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconBookmarkBorder;
//# sourceMappingURL=RuxIconBookmarkBorder.js.map