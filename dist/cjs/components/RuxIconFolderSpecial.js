...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_folder_special = internal_1.element("rux-icon-folder-special");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_folder_special, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_folder_special, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_folder_special, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_folder_special);
            if (default_slot)
...
class RuxIconFolderSpecial extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconFolderSpecial;
//# sourceMappingURL=RuxIconFolderSpecial.js.map