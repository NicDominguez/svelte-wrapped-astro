...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_scatter_plot = internal_1.element("rux-icon-scatter-plot");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_scatter_plot, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_scatter_plot, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_scatter_plot, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_scatter_plot);
            if (default_slot)
...
class RuxIconScatterPlot extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconScatterPlot;
//# sourceMappingURL=RuxIconScatterPlot.js.map