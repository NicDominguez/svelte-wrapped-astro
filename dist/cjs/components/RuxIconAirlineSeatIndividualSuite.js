...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_airline_seat_individual_suite = internal_1.element("rux-icon-airline-seat-individual-suite");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_airline_seat_individual_suite, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_airline_seat_individual_suite, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_airline_seat_individual_suite, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_airline_seat_individual_suite);
            if (default_slot)
...
class RuxIconAirlineSeatIndividualSuite extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconAirlineSeatIndividualSuite;
//# sourceMappingURL=RuxIconAirlineSeatIndividualSuite.js.map