...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_movies = internal_1.element("rux-icon-local-movies");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_local_movies, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_local_movies, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_local_movies, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_local_movies);
            if (default_slot)
...
class RuxIconLocalMovies extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconLocalMovies;
//# sourceMappingURL=RuxIconLocalMovies.js.map