...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_pharmacy = internal_1.element("rux-icon-local-pharmacy");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_local_pharmacy, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_local_pharmacy, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_local_pharmacy, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_local_pharmacy);
            if (default_slot)
...
class RuxIconLocalPharmacy extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconLocalPharmacy;
//# sourceMappingURL=RuxIconLocalPharmacy.js.map