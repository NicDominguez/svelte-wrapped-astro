...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cancel = internal_1.element("rux-icon-cancel");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_cancel, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_cancel, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_cancel, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_cancel);
            if (default_slot)
...
class RuxIconCancel extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconCancel;
//# sourceMappingURL=RuxIconCancel.js.map