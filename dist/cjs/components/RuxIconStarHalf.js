...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_star_half = internal_1.element("rux-icon-star-half");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_star_half, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_star_half, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_star_half, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_star_half);
            if (default_slot)
...
class RuxIconStarHalf extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconStarHalf;
//# sourceMappingURL=RuxIconStarHalf.js.map