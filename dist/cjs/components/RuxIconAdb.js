...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_adb = internal_1.element("rux-icon-adb");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_adb, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_adb, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_adb, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_adb);
            if (default_slot)
...
class RuxIconAdb extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconAdb;
//# sourceMappingURL=RuxIconAdb.js.map