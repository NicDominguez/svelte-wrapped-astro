...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_style = internal_1.element("rux-icon-style");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_style, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_style, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_style, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_style, null);
            }
            /*rux_icon_style_binding*/ ctx[6](rux_icon_style);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_style);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_style_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_style_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_style_binding];
}
class RuxIconStyle extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconStyle;
//# sourceMappingURL=RuxIconStyle.js.map