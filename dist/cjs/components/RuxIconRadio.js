...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_radio = internal_1.element("rux-icon-radio");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_radio, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_radio, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_radio, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_radio, null);
            }
            /*rux_icon_radio_binding*/ ctx[6](rux_icon_radio);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_radio);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_radio_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_radio_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_radio_binding];
}
class RuxIconRadio extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconRadio;
//# sourceMappingURL=RuxIconRadio.js.map