...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_last_page = internal_1.element("rux-icon-last-page");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_last_page, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_last_page, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_last_page, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_last_page);
            if (default_slot)
...
class RuxIconLastPage extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconLastPage;
//# sourceMappingURL=RuxIconLastPage.js.map