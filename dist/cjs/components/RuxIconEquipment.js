...
function create_fragment(ctx) {
    let rux_icon_equipment;
    let current;
    const default_slot_template = /*#slots*/ ctx[5].default;
    const default_slot = internal_1.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
    return {
        c() {
            rux_icon_equipment = internal_1.element("rux-icon-equipment");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_equipment, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_equipment, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_equipment, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_equipment, null);
            }
            /*rux_icon_equipment_binding*/ ctx[6](rux_icon_equipment);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_equipment);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_equipment_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_equipment_binding($$value) {
    ...
    return [
        ...
        $$scope,
        slots,
        rux_icon_equipment_binding
    ];
}
class RuxIconEquipment extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconEquipment;
//# sourceMappingURL=RuxIconEquipment.js.map