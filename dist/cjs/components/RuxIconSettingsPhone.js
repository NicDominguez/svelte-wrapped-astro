...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_settings_phone = internal_1.element("rux-icon-settings-phone");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_settings_phone, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_settings_phone, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_settings_phone, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_settings_phone);
            if (default_slot)
...
class RuxIconSettingsPhone extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconSettingsPhone;
//# sourceMappingURL=RuxIconSettingsPhone.js.map