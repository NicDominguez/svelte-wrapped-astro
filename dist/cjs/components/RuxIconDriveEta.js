...
function create_fragment(ctx) {
    let rux_icon_drive_eta;
    let current;
    const default_slot_template = /*#slots*/ ctx[5].default;
    const default_slot = internal_1.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
    return {
        c() {
            rux_icon_drive_eta = internal_1.element("rux-icon-drive-eta");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_drive_eta, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_drive_eta, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_drive_eta, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_drive_eta, null);
            }
            /*rux_icon_drive_eta_binding*/ ctx[6](rux_icon_drive_eta);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_drive_eta);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_drive_eta_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_drive_eta_binding($$value) {
    ...
    return [
        ...
        $$scope,
        slots,
        rux_icon_drive_eta_binding
    ];
}
class RuxIconDriveEta extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconDriveEta;
//# sourceMappingURL=RuxIconDriveEta.js.map