...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_question_answer = internal_1.element("rux-icon-question-answer");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_question_answer, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_question_answer, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_question_answer, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_question_answer);
            if (default_slot)
...
class RuxIconQuestionAnswer extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconQuestionAnswer;
//# sourceMappingURL=RuxIconQuestionAnswer.js.map