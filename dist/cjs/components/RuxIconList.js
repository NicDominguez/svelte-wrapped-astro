...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_list = internal_1.element("rux-icon-list");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_list, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_list, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_list, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_list, null);
            }
            /*rux_icon_list_binding*/ ctx[6](rux_icon_list);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_list);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_list_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_list_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_list_binding];
}
class RuxIconList extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconList;
//# sourceMappingURL=RuxIconList.js.map