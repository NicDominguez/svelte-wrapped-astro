...
function create_fragment(ctx) {
    let rux_icon_extension;
    let current;
    const default_slot_template = /*#slots*/ ctx[5].default;
    const default_slot = internal_1.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
    return {
        c() {
            rux_icon_extension = internal_1.element("rux-icon-extension");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_extension, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_extension, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_extension, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_extension, null);
            }
            /*rux_icon_extension_binding*/ ctx[6](rux_icon_extension);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_extension);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_extension_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_extension_binding($$value) {
    ...
    return [
        ...
        $$scope,
        slots,
        rux_icon_extension_binding
    ];
}
class RuxIconExtension extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconExtension;
//# sourceMappingURL=RuxIconExtension.js.map