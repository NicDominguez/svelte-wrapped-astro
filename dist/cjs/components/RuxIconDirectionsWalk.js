...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_directions_walk = internal_1.element("rux-icon-directions-walk");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_directions_walk, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_directions_walk, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_directions_walk, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_directions_walk);
            if (default_slot)
...
class RuxIconDirectionsWalk extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconDirectionsWalk;
//# sourceMappingURL=RuxIconDirectionsWalk.js.map