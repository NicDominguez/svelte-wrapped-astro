...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_add_to_photos = internal_1.element("rux-icon-add-to-photos");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_add_to_photos, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_add_to_photos, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_add_to_photos, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_add_to_photos);
            if (default_slot)
...
class RuxIconAddToPhotos extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconAddToPhotos;
