...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_branding_watermark = internal_1.element("rux-icon-branding-watermark");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_branding_watermark, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_branding_watermark, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_branding_watermark, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_branding_watermark);
            if (default_slot)
...
class RuxIconBrandingWatermark extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconBrandingWatermark;
//# sourceMappingURL=RuxIconBrandingWatermark.js.map