...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_call = internal_1.element("rux-icon-call");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_call, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_call, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_call, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_call, null);
            }
            /*rux_icon_call_binding*/ ctx[6](rux_icon_call);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_call);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_call_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_call_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_call_binding];
}
class RuxIconCall extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconCall;
//# sourceMappingURL=RuxIconCall.js.map