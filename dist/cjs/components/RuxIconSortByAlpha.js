...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sort_by_alpha = internal_1.element("rux-icon-sort-by-alpha");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_sort_by_alpha, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_sort_by_alpha, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_sort_by_alpha, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_sort_by_alpha);
            if (default_slot)
...
class RuxIconSortByAlpha extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconSortByAlpha;
//# sourceMappingURL=RuxIconSortByAlpha.js.map