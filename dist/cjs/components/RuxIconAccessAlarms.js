...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_access_alarms = internal_1.element("rux-icon-access-alarms");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_access_alarms, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_access_alarms, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_access_alarms, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_access_alarms);
            if (default_slot)
...
class RuxIconAccessAlarms extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconAccessAlarms;
//# sourceMappingURL=RuxIconAccessAlarms.js.map