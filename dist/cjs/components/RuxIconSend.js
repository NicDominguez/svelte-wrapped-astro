...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_send = internal_1.element("rux-icon-send");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_send, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_send, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_send, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_send, null);
            }
            /*rux_icon_send_binding*/ ctx[6](rux_icon_send);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_send);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_send_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_send_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_send_binding];
}
class RuxIconSend extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconSend;
//# sourceMappingURL=RuxIconSend.js.map