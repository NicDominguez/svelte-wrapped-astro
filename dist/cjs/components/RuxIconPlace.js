...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_place = internal_1.element("rux-icon-place");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_place, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_place, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_place, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_place, null);
            }
            /*rux_icon_place_binding*/ ctx[6](rux_icon_place);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_place);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_place_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_place_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_place_binding];
}
class RuxIconPlace extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconPlace;
//# sourceMappingURL=RuxIconPlace.js.map