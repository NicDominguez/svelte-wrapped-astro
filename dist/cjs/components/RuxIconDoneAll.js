...
function create_fragment(ctx) {
    let rux_icon_done_all;
    let current;
    const default_slot_template = /*#slots*/ ctx[5].default;
    const default_slot = internal_1.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
    return {
        c() {
            rux_icon_done_all = internal_1.element("rux-icon-done-all");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_done_all, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_done_all, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_done_all, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_done_all, null);
            }
            /*rux_icon_done_all_binding*/ ctx[6](rux_icon_done_all);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_done_all);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_done_all_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_done_all_binding($$value) {
    ...
    return [color, size, __ref, getWebComponent, $$scope, slots, rux_icon_done_all_binding];
}
class RuxIconDoneAll extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconDoneAll;
//# sourceMappingURL=RuxIconDoneAll.js.map