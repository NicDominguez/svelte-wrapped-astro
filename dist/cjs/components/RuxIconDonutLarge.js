...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_donut_large = internal_1.element("rux-icon-donut-large");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_donut_large, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_donut_large, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_donut_large, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_donut_large);
            if (default_slot)
...
class RuxIconDonutLarge extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconDonutLarge;
//# sourceMappingURL=RuxIconDonutLarge.js.map