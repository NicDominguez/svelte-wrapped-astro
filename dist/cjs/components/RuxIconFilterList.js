...
function create_fragment(ctx) {
    let rux_icon_filter_list;
    let current;
    const default_slot_template = /*#slots*/ ctx[5].default;
    const default_slot = internal_1.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
    return {
        c() {
            rux_icon_filter_list = internal_1.element("rux-icon-filter-list");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_filter_list, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_filter_list, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_filter_list, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_filter_list, null);
            }
            /*rux_icon_filter_list_binding*/ ctx[6](rux_icon_filter_list);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_filter_list);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_filter_list_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_filter_list_binding($$value) {
    ...
    return [
        ...
        $$scope,
        slots,
        rux_icon_filter_list_binding
    ];
}
class RuxIconFilterList extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconFilterList;
//# sourceMappingURL=RuxIconFilterList.js.map