...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_battery_alert = internal_1.element("rux-icon-battery-alert");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_battery_alert, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_battery_alert, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_battery_alert, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_battery_alert);
            if (default_slot)
...
class RuxIconBatteryAlert extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconBatteryAlert;
//# sourceMappingURL=RuxIconBatteryAlert.js.map