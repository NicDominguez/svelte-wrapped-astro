...
function create_fragment(ctx) {
    let rux_icon_navigation;
    let current;
    const default_slot_template = /*#slots*/ ctx[5].default;
    const default_slot = internal_1.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
    return {
        c() {
            rux_icon_navigation = internal_1.element("rux-icon-navigation");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_navigation, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_navigation, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_navigation, anchor);
            if (default_slot) {
                default_slot.m(rux_icon_navigation, null);
            }
            /*rux_icon_navigation_binding*/ ctx[6](rux_icon_navigation);
            current = true;
        },
        p(ctx, [dirty]) {
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_navigation);
            if (default_slot)
                default_slot.d(detaching);
            /*rux_icon_navigation_binding*/ ctx[6](null);
        }
    };
}
function instance($$self, $$props, $$invalidate) {
    ...
    function rux_icon_navigation_binding($$value) {
    ...
    return [
        ...
        $$scope,
        slots,
        rux_icon_navigation_binding
    ];
}
class RuxIconNavigation extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconNavigation;
//# sourceMappingURL=RuxIconNavigation.js.map