...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_smoke_free = internal_1.element("rux-icon-smoke-free");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_smoke_free, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_smoke_free, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_smoke_free, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_smoke_free);
            if (default_slot)
...
class RuxIconSmokeFree extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconSmokeFree;
//# sourceMappingURL=RuxIconSmokeFree.js.map