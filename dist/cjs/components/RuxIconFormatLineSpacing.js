...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_format_line_spacing = internal_1.element("rux-icon-format-line-spacing");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_format_line_spacing, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_format_line_spacing, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_format_line_spacing, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_format_line_spacing);
            if (default_slot)
...
class RuxIconFormatLineSpacing extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconFormatLineSpacing;
//# sourceMappingURL=RuxIconFormatLineSpacing.js.map