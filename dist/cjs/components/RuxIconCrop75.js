...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_7_5 = internal_1.element("rux-icon-crop-7-5");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_crop_7_5, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_crop_7_5, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_crop_7_5, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_crop_7_5);
            if (default_slot)
...
class RuxIconCrop75 extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconCrop75;
//# sourceMappingURL=RuxIconCrop75.js.map