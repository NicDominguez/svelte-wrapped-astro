...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_tab_panel = internal_1.element("rux-tab-panel");
            if (default_slot)
                default_slot.c();
        },
        m(target, anchor) {
            internal_1.insert(target, rux_tab_panel, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_tab_panel);
            if (default_slot)
...
class RuxTabPanel extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxTabPanel;
//# sourceMappingURL=RuxTabPanel.js.map