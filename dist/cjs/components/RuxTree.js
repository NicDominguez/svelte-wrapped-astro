...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_tree = internal_1.element("rux-tree");
            if (default_slot)
                default_slot.c();
        },
        m(target, anchor) {
            internal_1.insert(target, rux_tree, anchor);
            if (default_slot) {
...
class RuxTree extends internal_1.SvelteComponent {
    constructor(options) {
        super();
