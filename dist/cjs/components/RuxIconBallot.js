...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_ballot = internal_1.element("rux-icon-ballot");
            if (default_slot)
                default_slot.c();
            internal_1.set_custom_element_data(rux_icon_ballot, "color", /*color*/ ctx[0]);
            internal_1.set_custom_element_data(rux_icon_ballot, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            internal_1.insert(target, rux_icon_ballot, anchor);
            if (default_slot) {
        ...
        d(detaching) {
            if (detaching)
                internal_1.detach(rux_icon_ballot);
            if (default_slot)
...
class RuxIconBallot extends internal_1.SvelteComponent {
    constructor(options) {
        super();
...
exports.default = RuxIconBallot;
//# sourceMappingURL=RuxIconBallot.js.map