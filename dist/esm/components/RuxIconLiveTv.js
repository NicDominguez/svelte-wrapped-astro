...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_live_tv = element("rux-icon-live-tv");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_live_tv, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_live_tv, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_live_tv, anchor);
            if (default_slot) {
...
class RuxIconLiveTv extends SvelteComponent {
    constructor(options) {
        super();
