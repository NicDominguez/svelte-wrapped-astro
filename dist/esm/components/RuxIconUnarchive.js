...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_unarchive = element("rux-icon-unarchive");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_unarchive, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_unarchive, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_unarchive, anchor);
            if (default_slot) {
...
class RuxIconUnarchive extends SvelteComponent {
    constructor(options) {
        super();
