...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_check = element("rux-icon-check");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_check, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_check, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_check, anchor);
            if (default_slot) {
...
class RuxIconCheck extends SvelteComponent {
    constructor(options) {
        super();
