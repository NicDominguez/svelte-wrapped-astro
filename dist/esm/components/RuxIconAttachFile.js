...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_attach_file = element("rux-icon-attach-file");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_attach_file, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_attach_file, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_attach_file, anchor);
            if (default_slot) {
...
class RuxIconAttachFile extends SvelteComponent {
    constructor(options) {
        super();
