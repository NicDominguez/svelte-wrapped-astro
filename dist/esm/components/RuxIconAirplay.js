...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_airplay = element("rux-icon-airplay");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_airplay, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_airplay, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_airplay, anchor);
            if (default_slot) {
...
class RuxIconAirplay extends SvelteComponent {
    constructor(options) {
        super();
