...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_leak_remove = element("rux-icon-leak-remove");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_leak_remove, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_leak_remove, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_leak_remove, anchor);
            if (default_slot) {
...
class RuxIconLeakRemove extends SvelteComponent {
    constructor(options) {
        super();
