...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cloud_queue = element("rux-icon-cloud-queue");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_cloud_queue, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_cloud_queue, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_cloud_queue, anchor);
            if (default_slot) {
...
class RuxIconCloudQueue extends SvelteComponent {
    constructor(options) {
        super();
