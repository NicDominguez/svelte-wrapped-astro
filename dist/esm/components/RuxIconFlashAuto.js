...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_flash_auto = element("rux-icon-flash-auto");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_flash_auto, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_flash_auto, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_flash_auto, anchor);
            if (default_slot) {
...
class RuxIconFlashAuto extends SvelteComponent {
    constructor(options) {
        super();
