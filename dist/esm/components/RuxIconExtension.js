...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_extension = element("rux-icon-extension");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_extension, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_extension, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_extension, anchor);
            if (default_slot) {
...
class RuxIconExtension extends SvelteComponent {
    constructor(options) {
        super();
