...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_next_week = element("rux-icon-next-week");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_next_week, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_next_week, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_next_week, anchor);
            if (default_slot) {
...
class RuxIconNextWeek extends SvelteComponent {
    constructor(options) {
        super();
