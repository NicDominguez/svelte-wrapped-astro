...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_dialer_sip = element("rux-icon-dialer-sip");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_dialer_sip, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_dialer_sip, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_dialer_sip, anchor);
            if (default_slot) {
...
class RuxIconDialerSip extends SvelteComponent {
    constructor(options) {
        super();
