...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_quilt = element("rux-icon-view-quilt");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_quilt, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_quilt, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_quilt, anchor);
            if (default_slot) {
...
class RuxIconViewQuilt extends SvelteComponent {
    constructor(options) {
        super();
