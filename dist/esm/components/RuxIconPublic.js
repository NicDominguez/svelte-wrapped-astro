...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_public = element("rux-icon-public");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_public, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_public, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_public, anchor);
            if (default_slot) {
...
class RuxIconPublic extends SvelteComponent {
    constructor(options) {
        super();
