...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_navigation = element("rux-icon-navigation");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_navigation, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_navigation, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_navigation, anchor);
            if (default_slot) {
...
class RuxIconNavigation extends SvelteComponent {
    constructor(options) {
        super();
