...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_call_split = element("rux-icon-call-split");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_call_split, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_call_split, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_call_split, anchor);
            if (default_slot) {
...
class RuxIconCallSplit extends SvelteComponent {
    constructor(options) {
        super();
