...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_toc = element("rux-icon-toc");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_toc, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_toc, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_toc, anchor);
            if (default_slot) {
...
class RuxIconToc extends SvelteComponent {
    constructor(options) {
        super();
