...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_text_fields = element("rux-icon-text-fields");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_text_fields, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_text_fields, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_text_fields, anchor);
            if (default_slot) {
...
class RuxIconTextFields extends SvelteComponent {
    constructor(options) {
        super();
