...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_person_add = element("rux-icon-person-add");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_person_add, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_person_add, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_person_add, anchor);
            if (default_slot) {
...
class RuxIconPersonAdd extends SvelteComponent {
    constructor(options) {
        super();
