...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_power = element("rux-icon-power");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_power, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_power, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_power, anchor);
            if (default_slot) {
...
class RuxIconPower extends SvelteComponent {
    constructor(options) {
        super();
