...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_golf_course = element("rux-icon-golf-course");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_golf_course, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_golf_course, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_golf_course, anchor);
            if (default_slot) {
...
class RuxIconGolfCourse extends SvelteComponent {
    constructor(options) {
        super();
