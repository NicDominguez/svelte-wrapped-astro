...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_thumb_down = element("rux-icon-thumb-down");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_thumb_down, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_thumb_down, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_thumb_down, anchor);
            if (default_slot) {
...
class RuxIconThumbDown extends SvelteComponent {
    constructor(options) {
        super();
