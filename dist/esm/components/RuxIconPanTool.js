...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_pan_tool = element("rux-icon-pan-tool");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_pan_tool, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_pan_tool, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_pan_tool, anchor);
            if (default_slot) {
...
class RuxIconPanTool extends SvelteComponent {
    constructor(options) {
        super();
