...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_drive_eta = element("rux-icon-drive-eta");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_drive_eta, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_drive_eta, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_drive_eta, anchor);
            if (default_slot) {
...
class RuxIconDriveEta extends SvelteComponent {
    constructor(options) {
        super();
