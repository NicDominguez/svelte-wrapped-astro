...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_trip_origin = element("rux-icon-trip-origin");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_trip_origin, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_trip_origin, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_trip_origin, anchor);
            if (default_slot) {
...
class RuxIconTripOrigin extends SvelteComponent {
    constructor(options) {
        super();
