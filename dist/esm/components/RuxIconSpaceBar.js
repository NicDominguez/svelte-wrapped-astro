...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_space_bar = element("rux-icon-space-bar");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_space_bar, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_space_bar, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_space_bar, anchor);
            if (default_slot) {
...
class RuxIconSpaceBar extends SvelteComponent {
    constructor(options) {
        super();
