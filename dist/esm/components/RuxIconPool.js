...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_pool = element("rux-icon-pool");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_pool, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_pool, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_pool, anchor);
            if (default_slot) {
...
class RuxIconPool extends SvelteComponent {
    constructor(options) {
        super();
