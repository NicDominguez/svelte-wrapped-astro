...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_http = element("rux-icon-http");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_http, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_http, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_http, anchor);
            if (default_slot) {
...
class RuxIconHttp extends SvelteComponent {
    constructor(options) {
        super();
