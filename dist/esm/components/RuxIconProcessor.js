...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_processor = element("rux-icon-processor");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_processor, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_processor, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_processor, anchor);
            if (default_slot) {
...
class RuxIconProcessor extends SvelteComponent {
    constructor(options) {
        super();
