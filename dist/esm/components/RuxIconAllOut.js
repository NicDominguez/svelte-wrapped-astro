...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_all_out = element("rux-icon-all-out");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_all_out, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_all_out, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_all_out, anchor);
            if (default_slot) {
...
class RuxIconAllOut extends SvelteComponent {
    constructor(options) {
        super();
