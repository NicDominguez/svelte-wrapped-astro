...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_add_a_photo = element("rux-icon-add-a-photo");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_add_a_photo, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_add_a_photo, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_add_a_photo, anchor);
            if (default_slot) {
...
class RuxIconAddAPhoto extends SvelteComponent {
    constructor(options) {
        super();
