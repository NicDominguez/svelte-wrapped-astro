...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_router = element("rux-icon-router");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_router, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_router, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_router, anchor);
            if (default_slot) {
...
class RuxIconRouter extends SvelteComponent {
    constructor(options) {
        super();
