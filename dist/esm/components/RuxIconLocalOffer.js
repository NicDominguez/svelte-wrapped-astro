...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_offer = element("rux-icon-local-offer");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_offer, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_offer, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_offer, anchor);
            if (default_slot) {
...
class RuxIconLocalOffer extends SvelteComponent {
    constructor(options) {
        super();
