...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_mission = element("rux-icon-mission");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_mission, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_mission, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_mission, anchor);
            if (default_slot) {
...
class RuxIconMission extends SvelteComponent {
    constructor(options) {
        super();
