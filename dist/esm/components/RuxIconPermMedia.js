...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_perm_media = element("rux-icon-perm-media");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_perm_media, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_perm_media, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_perm_media, anchor);
            if (default_slot) {
...
class RuxIconPermMedia extends SvelteComponent {
    constructor(options) {
        super();
