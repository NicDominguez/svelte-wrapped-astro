...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_fullscreen = element("rux-icon-fullscreen");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_fullscreen, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_fullscreen, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_fullscreen, anchor);
            if (default_slot) {
...
class RuxIconFullscreen extends SvelteComponent {
    constructor(options) {
        super();
