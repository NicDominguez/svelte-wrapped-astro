...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_build = element("rux-icon-build");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_build, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_build, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_build, anchor);
            if (default_slot) {
...
class RuxIconBuild extends SvelteComponent {
    constructor(options) {
        super();
