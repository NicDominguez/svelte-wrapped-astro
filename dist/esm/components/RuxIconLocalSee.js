...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_see = element("rux-icon-local-see");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_see, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_see, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_see, anchor);
            if (default_slot) {
...
class RuxIconLocalSee extends SvelteComponent {
    constructor(options) {
        super();
