...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_place = element("rux-icon-place");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_place, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_place, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_place, anchor);
            if (default_slot) {
...
class RuxIconPlace extends SvelteComponent {
    constructor(options) {
        super();
