...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_schedule = element("rux-icon-schedule");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_schedule, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_schedule, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_schedule, anchor);
            if (default_slot) {
...
class RuxIconSchedule extends SvelteComponent {
    constructor(options) {
        super();
