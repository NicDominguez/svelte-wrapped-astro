...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_laptop_mac = element("rux-icon-laptop-mac");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_laptop_mac, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_laptop_mac, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_laptop_mac, anchor);
            if (default_slot) {
...
class RuxIconLaptopMac extends SvelteComponent {
    constructor(options) {
        super();
