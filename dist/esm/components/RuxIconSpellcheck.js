...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_spellcheck = element("rux-icon-spellcheck");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_spellcheck, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_spellcheck, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_spellcheck, anchor);
            if (default_slot) {
...
class RuxIconSpellcheck extends SvelteComponent {
    constructor(options) {
        super();
