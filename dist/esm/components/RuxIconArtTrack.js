...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_art_track = element("rux-icon-art-track");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_art_track, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_art_track, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_art_track, anchor);
            if (default_slot) {
...
class RuxIconArtTrack extends SvelteComponent {
    constructor(options) {
        super();
