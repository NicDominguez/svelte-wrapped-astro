...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_redeem = element("rux-icon-redeem");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_redeem, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_redeem, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_redeem, anchor);
            if (default_slot) {
...
class RuxIconRedeem extends SvelteComponent {
    constructor(options) {
        super();
