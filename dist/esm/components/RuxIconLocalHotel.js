...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_hotel = element("rux-icon-local-hotel");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_hotel, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_hotel, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_hotel, anchor);
            if (default_slot) {
...
class RuxIconLocalHotel extends SvelteComponent {
    constructor(options) {
        super();
