...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_room = element("rux-icon-room");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_room, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_room, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_room, anchor);
            if (default_slot) {
...
class RuxIconRoom extends SvelteComponent {
    constructor(options) {
        super();
