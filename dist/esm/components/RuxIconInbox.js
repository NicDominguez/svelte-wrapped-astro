...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_inbox = element("rux-icon-inbox");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_inbox, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_inbox, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_inbox, anchor);
            if (default_slot) {
...
class RuxIconInbox extends SvelteComponent {
    constructor(options) {
        super();
