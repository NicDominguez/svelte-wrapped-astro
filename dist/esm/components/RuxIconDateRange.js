...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_date_range = element("rux-icon-date-range");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_date_range, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_date_range, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_date_range, anchor);
            if (default_slot) {
...
class RuxIconDateRange extends SvelteComponent {
    constructor(options) {
        super();
