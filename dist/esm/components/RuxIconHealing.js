...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_healing = element("rux-icon-healing");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_healing, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_healing, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_healing, anchor);
            if (default_slot) {
...
class RuxIconHealing extends SvelteComponent {
    constructor(options) {
        super();
