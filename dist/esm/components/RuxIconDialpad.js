...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_dialpad = element("rux-icon-dialpad");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_dialpad, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_dialpad, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_dialpad, anchor);
            if (default_slot) {
...
class RuxIconDialpad extends SvelteComponent {
    constructor(options) {
        super();
