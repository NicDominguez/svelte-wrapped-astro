...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_power_input = element("rux-icon-power-input");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_power_input, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_power_input, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_power_input, anchor);
            if (default_slot) {
...
class RuxIconPowerInput extends SvelteComponent {
    constructor(options) {
        super();
