...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_unsubscribe = element("rux-icon-unsubscribe");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_unsubscribe, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_unsubscribe, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_unsubscribe, anchor);
            if (default_slot) {
...
class RuxIconUnsubscribe extends SvelteComponent {
    constructor(options) {
        super();
