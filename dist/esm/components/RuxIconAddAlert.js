...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_add_alert = element("rux-icon-add-alert");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_add_alert, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_add_alert, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_add_alert, anchor);
            if (default_slot) {
...
class RuxIconAddAlert extends SvelteComponent {
    constructor(options) {
        super();
