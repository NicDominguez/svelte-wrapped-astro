...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_keyboard = element("rux-icon-keyboard");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_keyboard, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_keyboard, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_keyboard, anchor);
            if (default_slot) {
...
class RuxIconKeyboard extends SvelteComponent {
    constructor(options) {
        super();
