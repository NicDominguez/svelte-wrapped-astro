...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_ac_unit = element("rux-icon-ac-unit");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_ac_unit, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_ac_unit, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_ac_unit, anchor);
            if (default_slot) {
...
class RuxIconAcUnit extends SvelteComponent {
    constructor(options) {
        super();
