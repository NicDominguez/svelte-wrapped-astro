...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_security = element("rux-icon-security");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_security, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_security, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_security, anchor);
            if (default_slot) {
...
class RuxIconSecurity extends SvelteComponent {
    constructor(options) {
        super();
