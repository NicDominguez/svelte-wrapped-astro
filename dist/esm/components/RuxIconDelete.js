...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_delete = element("rux-icon-delete");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_delete, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_delete, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_delete, anchor);
            if (default_slot) {
...
class RuxIconDelete extends SvelteComponent {
    constructor(options) {
        super();
