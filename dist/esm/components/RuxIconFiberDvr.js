...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_fiber_dvr = element("rux-icon-fiber-dvr");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_fiber_dvr, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_fiber_dvr, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_fiber_dvr, anchor);
            if (default_slot) {
...
class RuxIconFiberDvr extends SvelteComponent {
    constructor(options) {
        super();
