...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_360 = element("rux-icon-360");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_360, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_360, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_360, anchor);
            if (default_slot) {
...
class RuxIcon360 extends SvelteComponent {
    constructor(options) {
        super();
