...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_add_alarm = element("rux-icon-add-alarm");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_add_alarm, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_add_alarm, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_add_alarm, anchor);
            if (default_slot) {
...
class RuxIconAddAlarm extends SvelteComponent {
    constructor(options) {
        super();
