...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_history = element("rux-icon-history");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_history, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_history, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_history, anchor);
            if (default_slot) {
...
class RuxIconHistory extends SvelteComponent {
    constructor(options) {
        super();
