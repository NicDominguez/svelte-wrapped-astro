...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_file_copy = element("rux-icon-file-copy");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_file_copy, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_file_copy, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_file_copy, anchor);
            if (default_slot) {
...
class RuxIconFileCopy extends SvelteComponent {
    constructor(options) {
        super();
