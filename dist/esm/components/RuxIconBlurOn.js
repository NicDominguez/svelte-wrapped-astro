...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_blur_on = element("rux-icon-blur-on");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_blur_on, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_blur_on, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_blur_on, anchor);
            if (default_slot) {
...
class RuxIconBlurOn extends SvelteComponent {
    constructor(options) {
        super();
