...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_photo = element("rux-icon-photo");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_photo, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_photo, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_photo, anchor);
            if (default_slot) {
...
class RuxIconPhoto extends SvelteComponent {
    constructor(options) {
        super();
