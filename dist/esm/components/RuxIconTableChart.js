...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_table_chart = element("rux-icon-table-chart");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_table_chart, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_table_chart, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_table_chart, anchor);
            if (default_slot) {
...
class RuxIconTableChart extends SvelteComponent {
    constructor(options) {
        super();
