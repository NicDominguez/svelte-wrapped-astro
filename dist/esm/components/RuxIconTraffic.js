...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_traffic = element("rux-icon-traffic");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_traffic, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_traffic, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_traffic, anchor);
            if (default_slot) {
...
class RuxIconTraffic extends SvelteComponent {
    constructor(options) {
        super();
