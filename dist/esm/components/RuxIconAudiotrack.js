...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_audiotrack = element("rux-icon-audiotrack");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_audiotrack, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_audiotrack, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_audiotrack, anchor);
            if (default_slot) {
...
class RuxIconAudiotrack extends SvelteComponent {
    constructor(options) {
        super();
