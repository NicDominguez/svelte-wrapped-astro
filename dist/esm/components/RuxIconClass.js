...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_class = element("rux-icon-class");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_class, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_class, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_class, anchor);
            if (default_slot) {
...
class RuxIconClass extends SvelteComponent {
    constructor(options) {
        super();
