...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_terrain = element("rux-icon-terrain");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_terrain, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_terrain, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_terrain, anchor);
            if (default_slot) {
...
class RuxIconTerrain extends SvelteComponent {
    constructor(options) {
        super();
