...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_publish = element("rux-icon-publish");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_publish, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_publish, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_publish, anchor);
            if (default_slot) {
...
class RuxIconPublish extends SvelteComponent {
    constructor(options) {
        super();
