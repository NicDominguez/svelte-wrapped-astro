...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_square = element("rux-icon-crop-square");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_crop_square, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_crop_square, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_crop_square, anchor);
            if (default_slot) {
...
class RuxIconCropSquare extends SvelteComponent {
    constructor(options) {
        super();
