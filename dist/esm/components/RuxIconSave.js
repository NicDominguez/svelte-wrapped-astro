...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_save = element("rux-icon-save");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_save, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_save, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_save, anchor);
            if (default_slot) {
...
class RuxIconSave extends SvelteComponent {
    constructor(options) {
        super();
