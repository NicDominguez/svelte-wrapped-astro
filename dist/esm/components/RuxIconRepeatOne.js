...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_repeat_one = element("rux-icon-repeat-one");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_repeat_one, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_repeat_one, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_repeat_one, anchor);
            if (default_slot) {
...
class RuxIconRepeatOne extends SvelteComponent {
    constructor(options) {
        super();
