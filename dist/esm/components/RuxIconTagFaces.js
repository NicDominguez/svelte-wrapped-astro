...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_tag_faces = element("rux-icon-tag-faces");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_tag_faces, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_tag_faces, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_tag_faces, anchor);
            if (default_slot) {
...
class RuxIconTagFaces extends SvelteComponent {
    constructor(options) {
        super();
