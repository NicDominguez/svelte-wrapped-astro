...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_cafe = element("rux-icon-local-cafe");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_cafe, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_cafe, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_cafe, anchor);
            if (default_slot) {
...
class RuxIconLocalCafe extends SvelteComponent {
    constructor(options) {
        super();
