...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_label = element("rux-icon-label");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_label, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_label, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_label, anchor);
            if (default_slot) {
...
class RuxIconLabel extends SvelteComponent {
    constructor(options) {
        super();
