...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_flight_land = element("rux-icon-flight-land");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_flight_land, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_flight_land, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_flight_land, anchor);
            if (default_slot) {
...
class RuxIconFlightLand extends SvelteComponent {
    constructor(options) {
        super();
