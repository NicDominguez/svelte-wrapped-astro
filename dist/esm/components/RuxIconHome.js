...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_home = element("rux-icon-home");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_home, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_home, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_home, anchor);
            if (default_slot) {
...
class RuxIconHome extends SvelteComponent {
    constructor(options) {
        super();
