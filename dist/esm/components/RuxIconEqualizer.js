...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_equalizer = element("rux-icon-equalizer");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_equalizer, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_equalizer, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_equalizer, anchor);
            if (default_slot) {
...
class RuxIconEqualizer extends SvelteComponent {
    constructor(options) {
        super();
