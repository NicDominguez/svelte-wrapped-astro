...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_star_rate = element("rux-icon-star-rate");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_star_rate, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_star_rate, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_star_rate, anchor);
            if (default_slot) {
...
class RuxIconStarRate extends SvelteComponent {
    constructor(options) {
        super();
