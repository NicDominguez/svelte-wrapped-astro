...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_burst_mode = element("rux-icon-burst-mode");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_burst_mode, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_burst_mode, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_burst_mode, anchor);
            if (default_slot) {
...
class RuxIconBurstMode extends SvelteComponent {
    constructor(options) {
        super();
