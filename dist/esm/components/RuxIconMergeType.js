...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_merge_type = element("rux-icon-merge-type");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_merge_type, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_merge_type, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_merge_type, anchor);
            if (default_slot) {
...
class RuxIconMergeType extends SvelteComponent {
    constructor(options) {
        super();
