...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_ring_volume = element("rux-icon-ring-volume");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_ring_volume, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_ring_volume, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_ring_volume, anchor);
            if (default_slot) {
...
class RuxIconRingVolume extends SvelteComponent {
    constructor(options) {
        super();
