...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_av_timer = element("rux-icon-av-timer");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_av_timer, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_av_timer, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_av_timer, anchor);
            if (default_slot) {
...
class RuxIconAvTimer extends SvelteComponent {
    constructor(options) {
        super();
