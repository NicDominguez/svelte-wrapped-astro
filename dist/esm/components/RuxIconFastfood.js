...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_fastfood = element("rux-icon-fastfood");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_fastfood, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_fastfood, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_fastfood, anchor);
            if (default_slot) {
...
class RuxIconFastfood extends SvelteComponent {
    constructor(options) {
        super();
