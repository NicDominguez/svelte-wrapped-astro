...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_motorcycle = element("rux-icon-motorcycle");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_motorcycle, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_motorcycle, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_motorcycle, anchor);
            if (default_slot) {
...
class RuxIconMotorcycle extends SvelteComponent {
    constructor(options) {
        super();
