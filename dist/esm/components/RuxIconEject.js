...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_eject = element("rux-icon-eject");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_eject, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_eject, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_eject, anchor);
            if (default_slot) {
...
class RuxIconEject extends SvelteComponent {
    constructor(options) {
        super();
