...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_message = element("rux-icon-message");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_message, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_message, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_message, anchor);
            if (default_slot) {
...
class RuxIconMessage extends SvelteComponent {
    constructor(options) {
        super();
