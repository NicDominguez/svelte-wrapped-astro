...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_music_note = element("rux-icon-music-note");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_music_note, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_music_note, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_music_note, anchor);
            if (default_slot) {
...
class RuxIconMusicNote extends SvelteComponent {
    constructor(options) {
        super();
