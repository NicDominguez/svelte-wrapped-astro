...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_gavel = element("rux-icon-gavel");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_gavel, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_gavel, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_gavel, anchor);
            if (default_slot) {
...
class RuxIconGavel extends SvelteComponent {
    constructor(options) {
        super();
