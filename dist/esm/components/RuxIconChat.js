...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_chat = element("rux-icon-chat");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_chat, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_chat, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_chat, anchor);
            if (default_slot) {
...
class RuxIconChat extends SvelteComponent {
    constructor(options) {
        super();
