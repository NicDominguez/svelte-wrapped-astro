...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cached = element("rux-icon-cached");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_cached, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_cached, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_cached, anchor);
            if (default_slot) {
...
class RuxIconCached extends SvelteComponent {
    constructor(options) {
        super();
