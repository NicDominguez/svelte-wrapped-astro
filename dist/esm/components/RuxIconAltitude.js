...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_altitude = element("rux-icon-altitude");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_altitude, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_altitude, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_altitude, anchor);
            if (default_slot) {
...
class RuxIconAltitude extends SvelteComponent {
    constructor(options) {
        super();
