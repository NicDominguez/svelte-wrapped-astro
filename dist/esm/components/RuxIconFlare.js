...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_flare = element("rux-icon-flare");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_flare, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_flare, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_flare, anchor);
            if (default_slot) {
...
class RuxIconFlare extends SvelteComponent {
    constructor(options) {
        super();
