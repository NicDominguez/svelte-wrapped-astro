...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_rate_review = element("rux-icon-rate-review");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_rate_review, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_rate_review, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_rate_review, anchor);
            if (default_slot) {
...
class RuxIconRateReview extends SvelteComponent {
    constructor(options) {
        super();
