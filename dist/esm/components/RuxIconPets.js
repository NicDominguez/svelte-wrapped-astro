...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_pets = element("rux-icon-pets");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_pets, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_pets, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_pets, anchor);
            if (default_slot) {
...
class RuxIconPets extends SvelteComponent {
    constructor(options) {
        super();
