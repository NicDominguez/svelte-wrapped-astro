...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_face = element("rux-icon-face");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_face, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_face, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_face, anchor);
            if (default_slot) {
...
class RuxIconFace extends SvelteComponent {
    constructor(options) {
        super();
