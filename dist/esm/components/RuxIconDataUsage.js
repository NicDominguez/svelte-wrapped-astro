...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_data_usage = element("rux-icon-data-usage");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_data_usage, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_data_usage, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_data_usage, anchor);
            if (default_slot) {
...
class RuxIconDataUsage extends SvelteComponent {
    constructor(options) {
        super();
