...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_module = element("rux-icon-view-module");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_module, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_module, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_module, anchor);
            if (default_slot) {
...
class RuxIconViewModule extends SvelteComponent {
    constructor(options) {
        super();
