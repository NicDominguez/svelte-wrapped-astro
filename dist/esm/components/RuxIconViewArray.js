...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_array = element("rux-icon-view-array");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_array, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_array, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_array, anchor);
            if (default_slot) {
...
class RuxIconViewArray extends SvelteComponent {
    constructor(options) {
        super();
