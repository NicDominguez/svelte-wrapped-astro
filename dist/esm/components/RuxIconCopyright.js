...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_copyright = element("rux-icon-copyright");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_copyright, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_copyright, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_copyright, anchor);
            if (default_slot) {
...
class RuxIconCopyright extends SvelteComponent {
    constructor(options) {
        super();
