...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_expand_less = element("rux-icon-expand-less");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_expand_less, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_expand_less, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_expand_less, anchor);
            if (default_slot) {
...
class RuxIconExpandLess extends SvelteComponent {
    constructor(options) {
        super();
