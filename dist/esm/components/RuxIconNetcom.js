...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_netcom = element("rux-icon-netcom");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_netcom, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_netcom, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_netcom, anchor);
            if (default_slot) {
...
class RuxIconNetcom extends SvelteComponent {
    constructor(options) {
        super();
