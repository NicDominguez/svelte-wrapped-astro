...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_store = element("rux-icon-store");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_store, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_store, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_store, anchor);
            if (default_slot) {
...
class RuxIconStore extends SvelteComponent {
    constructor(options) {
        super();
