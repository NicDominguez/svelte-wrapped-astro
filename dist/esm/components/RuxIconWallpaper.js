...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_wallpaper = element("rux-icon-wallpaper");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_wallpaper, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_wallpaper, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_wallpaper, anchor);
            if (default_slot) {
...
class RuxIconWallpaper extends SvelteComponent {
    constructor(options) {
        super();
