...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_week = element("rux-icon-view-week");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_week, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_week, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_week, anchor);
            if (default_slot) {
...
class RuxIconViewWeek extends SvelteComponent {
    constructor(options) {
        super();
