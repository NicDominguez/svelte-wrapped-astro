...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_iso = element("rux-icon-iso");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_iso, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_iso, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_iso, anchor);
            if (default_slot) {
...
class RuxIconIso extends SvelteComponent {
    constructor(options) {
        super();
