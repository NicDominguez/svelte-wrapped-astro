...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_assessment = element("rux-icon-assessment");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_assessment, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_assessment, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_assessment, anchor);
            if (default_slot) {
...
class RuxIconAssessment extends SvelteComponent {
    constructor(options) {
        super();
