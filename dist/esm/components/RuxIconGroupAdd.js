...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_group_add = element("rux-icon-group-add");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_group_add, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_group_add, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_group_add, anchor);
            if (default_slot) {
...
class RuxIconGroupAdd extends SvelteComponent {
    constructor(options) {
        super();
