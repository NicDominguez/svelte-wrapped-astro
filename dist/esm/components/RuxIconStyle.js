...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_style = element("rux-icon-style");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_style, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_style, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_style, anchor);
            if (default_slot) {
...
class RuxIconStyle extends SvelteComponent {
    constructor(options) {
        super();
