...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_mail = element("rux-icon-mail");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_mail, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_mail, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_mail, anchor);
            if (default_slot) {
...
class RuxIconMail extends SvelteComponent {
    constructor(options) {
        super();
