...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_mall = element("rux-icon-local-mall");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_mall, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_mall, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_mall, anchor);
            if (default_slot) {
...
class RuxIconLocalMall extends SvelteComponent {
    constructor(options) {
        super();
