...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_pause = element("rux-icon-pause");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_pause, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_pause, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_pause, anchor);
            if (default_slot) {
...
class RuxIconPause extends SvelteComponent {
    constructor(options) {
        super();
