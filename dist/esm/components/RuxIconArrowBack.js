...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_arrow_back = element("rux-icon-arrow-back");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_arrow_back, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_arrow_back, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_arrow_back, anchor);
            if (default_slot) {
...
class RuxIconArrowBack extends SvelteComponent {
    constructor(options) {
        super();
