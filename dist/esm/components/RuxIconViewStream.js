...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_stream = element("rux-icon-view-stream");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_stream, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_stream, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_stream, anchor);
            if (default_slot) {
...
class RuxIconViewStream extends SvelteComponent {
    constructor(options) {
        super();
