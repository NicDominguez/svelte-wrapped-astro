...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_hdr_weak = element("rux-icon-hdr-weak");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_hdr_weak, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_hdr_weak, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_hdr_weak, anchor);
            if (default_slot) {
...
class RuxIconHdrWeak extends SvelteComponent {
    constructor(options) {
        super();
