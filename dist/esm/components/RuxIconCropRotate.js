...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_rotate = element("rux-icon-crop-rotate");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_crop_rotate, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_crop_rotate, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_crop_rotate, anchor);
            if (default_slot) {
...
class RuxIconCropRotate extends SvelteComponent {
    constructor(options) {
        super();
