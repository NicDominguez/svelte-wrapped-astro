...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_check_box = element("rux-icon-check-box");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_check_box, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_check_box, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_check_box, anchor);
            if (default_slot) {
...
class RuxIconCheckBox extends SvelteComponent {
    constructor(options) {
        super();
