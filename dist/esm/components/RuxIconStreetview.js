...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_streetview = element("rux-icon-streetview");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_streetview, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_streetview, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_streetview, anchor);
            if (default_slot) {
...
class RuxIconStreetview extends SvelteComponent {
    constructor(options) {
        super();
