...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_camera_roll = element("rux-icon-camera-roll");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_camera_roll, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_camera_roll, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_camera_roll, anchor);
            if (default_slot) {
...
class RuxIconCameraRoll extends SvelteComponent {
    constructor(options) {
        super();
