...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop = element("rux-icon-crop");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_crop, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_crop, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_crop, anchor);
            if (default_slot) {
...
class RuxIconCrop extends SvelteComponent {
    constructor(options) {
        super();
