...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_swap_calls = element("rux-icon-swap-calls");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_swap_calls, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_swap_calls, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_swap_calls, anchor);
            if (default_slot) {
...
class RuxIconSwapCalls extends SvelteComponent {
    constructor(options) {
        super();
