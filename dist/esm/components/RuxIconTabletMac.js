...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_tablet_mac = element("rux-icon-tablet-mac");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_tablet_mac, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_tablet_mac, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_tablet_mac, anchor);
            if (default_slot) {
...
class RuxIconTabletMac extends SvelteComponent {
    constructor(options) {
        super();
