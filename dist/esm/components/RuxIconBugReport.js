...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_bug_report = element("rux-icon-bug-report");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_bug_report, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_bug_report, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_bug_report, anchor);
            if (default_slot) {
...
class RuxIconBugReport extends SvelteComponent {
    constructor(options) {
        super();
