...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_info = element("rux-icon-info");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_info, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_info, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_info, anchor);
            if (default_slot) {
...
class RuxIconInfo extends SvelteComponent {
    constructor(options) {
        super();
