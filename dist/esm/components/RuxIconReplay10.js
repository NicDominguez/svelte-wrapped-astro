...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_replay_10 = element("rux-icon-replay-10");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_replay_10, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_replay_10, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_replay_10, anchor);
            if (default_slot) {
...
class RuxIconReplay10 extends SvelteComponent {
    constructor(options) {
        super();
