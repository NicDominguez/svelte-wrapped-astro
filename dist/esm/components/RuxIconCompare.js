...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_compare = element("rux-icon-compare");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_compare, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_compare, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_compare, anchor);
            if (default_slot) {
...
class RuxIconCompare extends SvelteComponent {
    constructor(options) {
        super();
