...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_reorder = element("rux-icon-reorder");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_reorder, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_reorder, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_reorder, anchor);
            if (default_slot) {
...
class RuxIconReorder extends SvelteComponent {
    constructor(options) {
        super();
