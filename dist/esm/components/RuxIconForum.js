...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_forum = element("rux-icon-forum");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_forum, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_forum, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_forum, anchor);
            if (default_slot) {
...
class RuxIconForum extends SvelteComponent {
    constructor(options) {
        super();
