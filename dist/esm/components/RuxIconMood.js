...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_mood = element("rux-icon-mood");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_mood, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_mood, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_mood, anchor);
            if (default_slot) {
...
class RuxIconMood extends SvelteComponent {
    constructor(options) {
        super();
