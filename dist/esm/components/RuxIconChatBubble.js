...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_chat_bubble = element("rux-icon-chat-bubble");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_chat_bubble, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_chat_bubble, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_chat_bubble, anchor);
            if (default_slot) {
...
class RuxIconChatBubble extends SvelteComponent {
    constructor(options) {
        super();
