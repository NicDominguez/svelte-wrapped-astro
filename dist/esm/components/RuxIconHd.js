...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_hd = element("rux-icon-hd");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_hd, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_hd, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_hd, anchor);
            if (default_slot) {
...
class RuxIconHd extends SvelteComponent {
    constructor(options) {
        super();
