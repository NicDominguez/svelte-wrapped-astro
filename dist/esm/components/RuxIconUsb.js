...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_usb = element("rux-icon-usb");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_usb, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_usb, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_usb, anchor);
            if (default_slot) {
...
class RuxIconUsb extends SvelteComponent {
    constructor(options) {
        super();
