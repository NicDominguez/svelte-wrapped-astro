...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_euro_symbol = element("rux-icon-euro-symbol");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_euro_symbol, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_euro_symbol, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_euro_symbol, anchor);
            if (default_slot) {
...
class RuxIconEuroSymbol extends SvelteComponent {
    constructor(options) {
        super();
