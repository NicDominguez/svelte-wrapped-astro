...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_send = element("rux-icon-send");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_send, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_send, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_send, anchor);
            if (default_slot) {
...
class RuxIconSend extends SvelteComponent {
    constructor(options) {
        super();
