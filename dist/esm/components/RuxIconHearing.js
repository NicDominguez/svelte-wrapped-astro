...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_hearing = element("rux-icon-hearing");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_hearing, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_hearing, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_hearing, anchor);
            if (default_slot) {
...
class RuxIconHearing extends SvelteComponent {
    constructor(options) {
        super();
