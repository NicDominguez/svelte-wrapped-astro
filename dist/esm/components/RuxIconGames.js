...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_games = element("rux-icon-games");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_games, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_games, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_games, anchor);
            if (default_slot) {
...
class RuxIconGames extends SvelteComponent {
    constructor(options) {
        super();
