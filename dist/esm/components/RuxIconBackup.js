...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_backup = element("rux-icon-backup");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_backup, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_backup, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_backup, anchor);
            if (default_slot) {
...
class RuxIconBackup extends SvelteComponent {
    constructor(options) {
        super();
