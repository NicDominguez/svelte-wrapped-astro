...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_shuffle = element("rux-icon-shuffle");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_shuffle, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_shuffle, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_shuffle, anchor);
            if (default_slot) {
...
class RuxIconShuffle extends SvelteComponent {
    constructor(options) {
        super();
