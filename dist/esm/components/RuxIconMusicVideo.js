...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_music_video = element("rux-icon-music-video");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_music_video, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_music_video, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_music_video, anchor);
            if (default_slot) {
...
class RuxIconMusicVideo extends SvelteComponent {
    constructor(options) {
        super();
