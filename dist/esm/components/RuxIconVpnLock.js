...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_vpn_lock = element("rux-icon-vpn-lock");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_vpn_lock, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_vpn_lock, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_vpn_lock, anchor);
            if (default_slot) {
...
class RuxIconVpnLock extends SvelteComponent {
    constructor(options) {
        super();
