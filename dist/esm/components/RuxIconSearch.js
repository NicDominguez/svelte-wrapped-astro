...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_search = element("rux-icon-search");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_search, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_search, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_search, anchor);
            if (default_slot) {
...
class RuxIconSearch extends SvelteComponent {
    constructor(options) {
        super();
