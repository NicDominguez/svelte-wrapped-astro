...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_column = element("rux-icon-view-column");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_column, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_column, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_column, anchor);
            if (default_slot) {
...
class RuxIconViewColumn extends SvelteComponent {
    constructor(options) {
        super();
