...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_seat = element("rux-icon-seat");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_seat, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_seat, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_seat, anchor);
            if (default_slot) {
...
class RuxIconSeat extends SvelteComponent {
    constructor(options) {
        super();
