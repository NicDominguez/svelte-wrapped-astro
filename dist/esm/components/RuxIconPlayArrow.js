...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_play_arrow = element("rux-icon-play-arrow");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_play_arrow, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_play_arrow, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_play_arrow, anchor);
            if (default_slot) {
...
class RuxIconPlayArrow extends SvelteComponent {
    constructor(options) {
        super();
