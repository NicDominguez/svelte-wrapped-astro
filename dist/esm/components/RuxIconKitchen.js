...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_kitchen = element("rux-icon-kitchen");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_kitchen, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_kitchen, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_kitchen, anchor);
            if (default_slot) {
...
class RuxIconKitchen extends SvelteComponent {
    constructor(options) {
        super();
