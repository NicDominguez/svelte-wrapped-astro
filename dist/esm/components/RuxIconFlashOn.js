...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_flash_on = element("rux-icon-flash-on");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_flash_on, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_flash_on, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_flash_on, anchor);
            if (default_slot) {
...
class RuxIconFlashOn extends SvelteComponent {
    constructor(options) {
        super();
