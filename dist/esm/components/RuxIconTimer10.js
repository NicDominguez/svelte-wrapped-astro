...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_timer_10 = element("rux-icon-timer-10");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_timer_10, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_timer_10, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_timer_10, anchor);
            if (default_slot) {
...
class RuxIconTimer10 extends SvelteComponent {
    constructor(options) {
        super();
