...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_map = element("rux-icon-map");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_map, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_map, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_map, anchor);
            if (default_slot) {
...
class RuxIconMap extends SvelteComponent {
    constructor(options) {
        super();
