...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_rss_feed = element("rux-icon-rss-feed");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_rss_feed, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_rss_feed, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_rss_feed, anchor);
            if (default_slot) {
...
class RuxIconRssFeed extends SvelteComponent {
    constructor(options) {
        super();
