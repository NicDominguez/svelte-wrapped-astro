...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_event_note = element("rux-icon-event-note");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_event_note, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_event_note, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_event_note, anchor);
            if (default_slot) {
...
class RuxIconEventNote extends SvelteComponent {
    constructor(options) {
        super();
