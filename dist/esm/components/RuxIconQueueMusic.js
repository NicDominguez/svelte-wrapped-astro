...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_queue_music = element("rux-icon-queue-music");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_queue_music, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_queue_music, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_queue_music, anchor);
            if (default_slot) {
...
class RuxIconQueueMusic extends SvelteComponent {
    constructor(options) {
        super();
