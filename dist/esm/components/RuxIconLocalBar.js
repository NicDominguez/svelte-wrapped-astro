...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_bar = element("rux-icon-local-bar");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_bar, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_bar, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_bar, anchor);
            if (default_slot) {
...
class RuxIconLocalBar extends SvelteComponent {
    constructor(options) {
        super();
