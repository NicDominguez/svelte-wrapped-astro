...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_music_off = element("rux-icon-music-off");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_music_off, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_music_off, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_music_off, anchor);
            if (default_slot) {
...
class RuxIconMusicOff extends SvelteComponent {
    constructor(options) {
        super();
