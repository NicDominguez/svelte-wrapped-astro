...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_open_with = element("rux-icon-open-with");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_open_with, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_open_with, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_open_with, anchor);
            if (default_slot) {
...
class RuxIconOpenWith extends SvelteComponent {
    constructor(options) {
        super();
