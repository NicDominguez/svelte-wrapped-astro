...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_exposure = element("rux-icon-exposure");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_exposure, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_exposure, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_exposure, anchor);
            if (default_slot) {
...
class RuxIconExposure extends SvelteComponent {
    constructor(options) {
        super();
