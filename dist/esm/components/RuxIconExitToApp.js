...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_exit_to_app = element("rux-icon-exit-to-app");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_exit_to_app, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_exit_to_app, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_exit_to_app, anchor);
            if (default_slot) {
...
class RuxIconExitToApp extends SvelteComponent {
    constructor(options) {
        super();
