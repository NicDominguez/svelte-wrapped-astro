...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_tablet = element("rux-icon-tablet");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_tablet, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_tablet, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_tablet, anchor);
            if (default_slot) {
...
class RuxIconTablet extends SvelteComponent {
    constructor(options) {
        super();
