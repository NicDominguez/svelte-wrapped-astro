...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_graphic_eq = element("rux-icon-graphic-eq");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_graphic_eq, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_graphic_eq, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_graphic_eq, anchor);
            if (default_slot) {
...
class RuxIconGraphicEq extends SvelteComponent {
    constructor(options) {
        super();
