...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_palette = element("rux-icon-palette");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_palette, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_palette, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_palette, anchor);
            if (default_slot) {
...
class RuxIconPalette extends SvelteComponent {
    constructor(options) {
        super();
