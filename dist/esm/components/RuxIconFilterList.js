...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_filter_list = element("rux-icon-filter-list");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_filter_list, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_filter_list, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_filter_list, anchor);
            if (default_slot) {
...
class RuxIconFilterList extends SvelteComponent {
    constructor(options) {
        super();
