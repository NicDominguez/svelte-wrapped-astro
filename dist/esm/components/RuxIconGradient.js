...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_gradient = element("rux-icon-gradient");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_gradient, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_gradient, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_gradient, anchor);
            if (default_slot) {
...
class RuxIconGradient extends SvelteComponent {
    constructor(options) {
        super();
