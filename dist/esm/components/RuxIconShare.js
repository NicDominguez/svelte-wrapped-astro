...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_share = element("rux-icon-share");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_share, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_share, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_share, anchor);
            if (default_slot) {
...
class RuxIconShare extends SvelteComponent {
    constructor(options) {
        super();
