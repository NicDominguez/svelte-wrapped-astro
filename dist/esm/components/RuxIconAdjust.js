...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_adjust = element("rux-icon-adjust");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_adjust, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_adjust, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_adjust, anchor);
            if (default_slot) {
...
class RuxIconAdjust extends SvelteComponent {
    constructor(options) {
        super();
