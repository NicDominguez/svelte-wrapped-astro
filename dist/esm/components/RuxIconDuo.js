...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_duo = element("rux-icon-duo");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_duo, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_duo, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_duo, anchor);
            if (default_slot) {
...
class RuxIconDuo extends SvelteComponent {
    constructor(options) {
        super();
