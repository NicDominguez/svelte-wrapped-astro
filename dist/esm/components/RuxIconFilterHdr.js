...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_filter_hdr = element("rux-icon-filter-hdr");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_filter_hdr, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_filter_hdr, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_filter_hdr, anchor);
            if (default_slot) {
...
class RuxIconFilterHdr extends SvelteComponent {
    constructor(options) {
        super();
