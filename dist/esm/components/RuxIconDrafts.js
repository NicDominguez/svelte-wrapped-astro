...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_drafts = element("rux-icon-drafts");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_drafts, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_drafts, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_drafts, anchor);
            if (default_slot) {
...
class RuxIconDrafts extends SvelteComponent {
    constructor(options) {
        super();
