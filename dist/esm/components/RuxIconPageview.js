...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_pageview = element("rux-icon-pageview");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_pageview, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_pageview, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_pageview, anchor);
            if (default_slot) {
...
class RuxIconPageview extends SvelteComponent {
    constructor(options) {
        super();
