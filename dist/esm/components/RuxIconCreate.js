...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_create = element("rux-icon-create");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_create, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_create, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_create, anchor);
            if (default_slot) {
...
class RuxIconCreate extends SvelteComponent {
    constructor(options) {
        super();
