...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_title = element("rux-icon-title");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_title, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_title, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_title, anchor);
            if (default_slot) {
...
class RuxIconTitle extends SvelteComponent {
    constructor(options) {
        super();
