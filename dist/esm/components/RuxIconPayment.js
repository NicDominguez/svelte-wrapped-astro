...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_payment = element("rux-icon-payment");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_payment, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_payment, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_payment, anchor);
            if (default_slot) {
...
class RuxIconPayment extends SvelteComponent {
    constructor(options) {
        super();
