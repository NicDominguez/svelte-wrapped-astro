...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_refresh = element("rux-icon-refresh");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_refresh, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_refresh, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_refresh, anchor);
            if (default_slot) {
...
class RuxIconRefresh extends SvelteComponent {
    constructor(options) {
        super();
