...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_thumb_up = element("rux-icon-thumb-up");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_thumb_up, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_thumb_up, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_thumb_up, anchor);
            if (default_slot) {
...
class RuxIconThumbUp extends SvelteComponent {
    constructor(options) {
        super();
