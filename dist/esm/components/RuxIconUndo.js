...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_undo = element("rux-icon-undo");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_undo, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_undo, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_undo, anchor);
            if (default_slot) {
...
class RuxIconUndo extends SvelteComponent {
    constructor(options) {
        super();
