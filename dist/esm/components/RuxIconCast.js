...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cast = element("rux-icon-cast");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_cast, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_cast, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_cast, anchor);
            if (default_slot) {
...
class RuxIconCast extends SvelteComponent {
    constructor(options) {
        super();
