...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_wb_auto = element("rux-icon-wb-auto");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_wb_auto, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_wb_auto, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_wb_auto, anchor);
            if (default_slot) {
...
class RuxIconWbAuto extends SvelteComponent {
    constructor(options) {
        super();
