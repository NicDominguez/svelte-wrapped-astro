...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_tab = element("rux-icon-tab");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_tab, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_tab, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_tab, anchor);
            if (default_slot) {
...
class RuxIconTab extends SvelteComponent {
    constructor(options) {
        super();
