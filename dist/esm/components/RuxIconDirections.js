...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_directions = element("rux-icon-directions");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_directions, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_directions, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_directions, anchor);
            if (default_slot) {
...
class RuxIconDirections extends SvelteComponent {
    constructor(options) {
        super();
