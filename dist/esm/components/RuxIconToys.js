...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_toys = element("rux-icon-toys");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_toys, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_toys, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_toys, anchor);
            if (default_slot) {
...
class RuxIconToys extends SvelteComponent {
    constructor(options) {
        super();
