...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_rv_hookup = element("rux-icon-rv-hookup");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_rv_hookup, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_rv_hookup, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_rv_hookup, anchor);
            if (default_slot) {
...
class RuxIconRvHookup extends SvelteComponent {
    constructor(options) {
        super();
