...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_antenna = element("rux-icon-antenna");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_antenna, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_antenna, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_antenna, anchor);
            if (default_slot) {
...
class RuxIconAntenna extends SvelteComponent {
    constructor(options) {
        super();
