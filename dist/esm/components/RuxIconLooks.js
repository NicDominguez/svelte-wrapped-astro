...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_looks = element("rux-icon-looks");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_looks, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_looks, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_looks, anchor);
            if (default_slot) {
...
class RuxIconLooks extends SvelteComponent {
    constructor(options) {
        super();
