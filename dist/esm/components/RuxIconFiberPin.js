...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_fiber_pin = element("rux-icon-fiber-pin");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_fiber_pin, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_fiber_pin, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_fiber_pin, anchor);
            if (default_slot) {
...
class RuxIconFiberPin extends SvelteComponent {
    constructor(options) {
        super();
