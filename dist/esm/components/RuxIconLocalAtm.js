...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_atm = element("rux-icon-local-atm");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_atm, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_atm, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_atm, anchor);
            if (default_slot) {
...
class RuxIconLocalAtm extends SvelteComponent {
    constructor(options) {
        super();
