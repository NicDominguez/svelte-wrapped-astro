...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_5_4 = element("rux-icon-crop-5-4");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_crop_5_4, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_crop_5_4, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_crop_5_4, anchor);
            if (default_slot) {
...
class RuxIconCrop54 extends SvelteComponent {
    constructor(options) {
        super();
