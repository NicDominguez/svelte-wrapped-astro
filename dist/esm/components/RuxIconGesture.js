...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_gesture = element("rux-icon-gesture");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_gesture, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_gesture, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_gesture, anchor);
            if (default_slot) {
...
class RuxIconGesture extends SvelteComponent {
    constructor(options) {
        super();
