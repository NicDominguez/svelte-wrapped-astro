...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_texture = element("rux-icon-texture");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_texture, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_texture, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_texture, anchor);
            if (default_slot) {
...
class RuxIconTexture extends SvelteComponent {
    constructor(options) {
        super();
