...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_settings = element("rux-icon-settings");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_settings, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_settings, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_settings, anchor);
            if (default_slot) {
...
class RuxIconSettings extends SvelteComponent {
    constructor(options) {
        super();
