...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_transform = element("rux-icon-transform");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_transform, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_transform, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_transform, anchor);
            if (default_slot) {
...
class RuxIconTransform extends SvelteComponent {
    constructor(options) {
        super();
