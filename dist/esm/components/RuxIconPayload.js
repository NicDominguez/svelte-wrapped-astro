...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_payload = element("rux-icon-payload");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_payload, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_payload, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_payload, anchor);
            if (default_slot) {
...
class RuxIconPayload extends SvelteComponent {
    constructor(options) {
        super();
