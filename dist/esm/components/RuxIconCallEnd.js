...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_call_end = element("rux-icon-call-end");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_call_end, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_call_end, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_call_end, anchor);
            if (default_slot) {
...
class RuxIconCallEnd extends SvelteComponent {
    constructor(options) {
        super();
