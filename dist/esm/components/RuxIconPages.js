...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_pages = element("rux-icon-pages");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_pages, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_pages, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_pages, anchor);
            if (default_slot) {
...
class RuxIconPages extends SvelteComponent {
    constructor(options) {
        super();
