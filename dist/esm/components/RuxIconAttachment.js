...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_attachment = element("rux-icon-attachment");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_attachment, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_attachment, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_attachment, anchor);
            if (default_slot) {
...
class RuxIconAttachment extends SvelteComponent {
    constructor(options) {
        super();
