...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_minimize = element("rux-icon-minimize");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_minimize, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_minimize, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_minimize, anchor);
            if (default_slot) {
...
class RuxIconMinimize extends SvelteComponent {
    constructor(options) {
        super();
