...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_opacity = element("rux-icon-opacity");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_opacity, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_opacity, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_opacity, anchor);
            if (default_slot) {
...
class RuxIconOpacity extends SvelteComponent {
    constructor(options) {
        super();
