...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_battery_30 = element("rux-icon-battery-30");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_battery_30, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_battery_30, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_battery_30, anchor);
            if (default_slot) {
...
class RuxIconBattery30 extends SvelteComponent {
    constructor(options) {
        super();
