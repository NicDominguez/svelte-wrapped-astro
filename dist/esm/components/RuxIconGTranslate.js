...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_g_translate = element("rux-icon-g-translate");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_g_translate, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_g_translate, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_g_translate, anchor);
            if (default_slot) {
...
class RuxIconGTranslate extends SvelteComponent {
    constructor(options) {
        super();
