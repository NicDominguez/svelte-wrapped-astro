...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_web_asset = element("rux-icon-web-asset");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_web_asset, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_web_asset, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_web_asset, anchor);
            if (default_slot) {
...
class RuxIconWebAsset extends SvelteComponent {
    constructor(options) {
        super();
