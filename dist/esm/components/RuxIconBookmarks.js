...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_bookmarks = element("rux-icon-bookmarks");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_bookmarks, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_bookmarks, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_bookmarks, anchor);
            if (default_slot) {
...
class RuxIconBookmarks extends SvelteComponent {
    constructor(options) {
        super();
