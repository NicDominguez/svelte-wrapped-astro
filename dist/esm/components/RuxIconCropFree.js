...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_free = element("rux-icon-crop-free");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_crop_free, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_crop_free, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_crop_free, anchor);
            if (default_slot) {
...
class RuxIconCropFree extends SvelteComponent {
    constructor(options) {
        super();
