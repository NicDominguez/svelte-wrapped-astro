...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_brush = element("rux-icon-brush");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_brush, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_brush, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_brush, anchor);
            if (default_slot) {
...
class RuxIconBrush extends SvelteComponent {
    constructor(options) {
        super();
