...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_speaker = element("rux-icon-speaker");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_speaker, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_speaker, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_speaker, anchor);
            if (default_slot) {
...
class RuxIconSpeaker extends SvelteComponent {
    constructor(options) {
        super();
