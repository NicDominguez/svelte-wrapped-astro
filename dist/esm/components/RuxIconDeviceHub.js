...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_device_hub = element("rux-icon-device-hub");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_device_hub, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_device_hub, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_device_hub, anchor);
            if (default_slot) {
...
class RuxIconDeviceHub extends SvelteComponent {
    constructor(options) {
        super();
