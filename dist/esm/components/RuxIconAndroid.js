...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_android = element("rux-icon-android");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_android, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_android, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_android, anchor);
            if (default_slot) {
...
class RuxIconAndroid extends SvelteComponent {
    constructor(options) {
        super();
