...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_4k = element("rux-icon-4k");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_4k, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_4k, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_4k, anchor);
            if (default_slot) {
...
class RuxIcon4k extends SvelteComponent {
    constructor(options) {
        super();
