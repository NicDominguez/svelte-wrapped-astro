...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_grid_off = element("rux-icon-grid-off");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_grid_off, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_grid_off, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_grid_off, anchor);
            if (default_slot) {
...
class RuxIconGridOff extends SvelteComponent {
    constructor(options) {
        super();
