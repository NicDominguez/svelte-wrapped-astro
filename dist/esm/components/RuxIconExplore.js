...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_explore = element("rux-icon-explore");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_explore, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_explore, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_explore, anchor);
            if (default_slot) {
...
class RuxIconExplore extends SvelteComponent {
    constructor(options) {
        super();
