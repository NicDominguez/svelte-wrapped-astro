...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_notes = element("rux-icon-notes");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_notes, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_notes, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_notes, anchor);
            if (default_slot) {
...
class RuxIconNotes extends SvelteComponent {
    constructor(options) {
        super();
