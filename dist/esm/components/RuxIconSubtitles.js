...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_subtitles = element("rux-icon-subtitles");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_subtitles, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_subtitles, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_subtitles, anchor);
            if (default_slot) {
...
class RuxIconSubtitles extends SvelteComponent {
    constructor(options) {
        super();
