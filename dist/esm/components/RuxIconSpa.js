...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_spa = element("rux-icon-spa");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_spa, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_spa, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_spa, anchor);
            if (default_slot) {
...
class RuxIconSpa extends SvelteComponent {
    constructor(options) {
        super();
