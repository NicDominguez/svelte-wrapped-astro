...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_volume_down = element("rux-icon-volume-down");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_volume_down, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_volume_down, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_volume_down, anchor);
            if (default_slot) {
...
class RuxIconVolumeDown extends SvelteComponent {
    constructor(options) {
        super();
