...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_child_care = element("rux-icon-child-care");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_child_care, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_child_care, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_child_care, anchor);
            if (default_slot) {
...
class RuxIconChildCare extends SvelteComponent {
    constructor(options) {
        super();
