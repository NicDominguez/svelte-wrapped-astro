...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_clear = element("rux-icon-clear");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_clear, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_clear, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_clear, anchor);
            if (default_slot) {
...
class RuxIconClear extends SvelteComponent {
    constructor(options) {
        super();
