...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_pin_drop = element("rux-icon-pin-drop");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_pin_drop, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_pin_drop, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_pin_drop, anchor);
            if (default_slot) {
...
class RuxIconPinDrop extends SvelteComponent {
    constructor(options) {
        super();
