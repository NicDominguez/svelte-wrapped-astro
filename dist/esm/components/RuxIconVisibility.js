...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_visibility = element("rux-icon-visibility");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_visibility, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_visibility, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_visibility, anchor);
            if (default_slot) {
...
class RuxIconVisibility extends SvelteComponent {
    constructor(options) {
        super();
