...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_how_to_reg = element("rux-icon-how-to-reg");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_how_to_reg, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_how_to_reg, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_how_to_reg, anchor);
            if (default_slot) {
...
class RuxIconHowToReg extends SvelteComponent {
    constructor(options) {
        super();
