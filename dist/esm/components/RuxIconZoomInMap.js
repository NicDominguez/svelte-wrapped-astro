...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_zoom_in_map = element("rux-icon-zoom-in-map");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_zoom_in_map, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_zoom_in_map, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_zoom_in_map, anchor);
            if (default_slot) {
...
class RuxIconZoomInMap extends SvelteComponent {
    constructor(options) {
        super();
