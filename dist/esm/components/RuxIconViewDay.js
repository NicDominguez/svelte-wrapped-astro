...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_day = element("rux-icon-view-day");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_day, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_day, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_day, anchor);
            if (default_slot) {
...
class RuxIconViewDay extends SvelteComponent {
    constructor(options) {
        super();
