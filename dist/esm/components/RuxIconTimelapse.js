...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_timelapse = element("rux-icon-timelapse");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_timelapse, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_timelapse, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_timelapse, anchor);
            if (default_slot) {
...
class RuxIconTimelapse extends SvelteComponent {
    constructor(options) {
        super();
