...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_favorite = element("rux-icon-favorite");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_favorite, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_favorite, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_favorite, anchor);
            if (default_slot) {
...
class RuxIconFavorite extends SvelteComponent {
    constructor(options) {
        super();
