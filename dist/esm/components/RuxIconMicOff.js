...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_mic_off = element("rux-icon-mic-off");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_mic_off, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_mic_off, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_mic_off, anchor);
            if (default_slot) {
...
class RuxIconMicOff extends SvelteComponent {
    constructor(options) {
        super();
