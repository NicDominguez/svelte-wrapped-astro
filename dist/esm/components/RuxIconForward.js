...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_forward = element("rux-icon-forward");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_forward, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_forward, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_forward, anchor);
            if (default_slot) {
...
class RuxIconForward extends SvelteComponent {
    constructor(options) {
        super();
