...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_weekend = element("rux-icon-weekend");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_weekend, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_weekend, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_weekend, anchor);
            if (default_slot) {
...
class RuxIconWeekend extends SvelteComponent {
    constructor(options) {
        super();
