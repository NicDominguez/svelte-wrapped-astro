...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_phone = element("rux-icon-phone");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_phone, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_phone, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_phone, anchor);
            if (default_slot) {
...
class RuxIconPhone extends SvelteComponent {
    constructor(options) {
        super();
