...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_mood_bad = element("rux-icon-mood-bad");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_mood_bad, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_mood_bad, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_mood_bad, anchor);
            if (default_slot) {
...
class RuxIconMoodBad extends SvelteComponent {
    constructor(options) {
        super();
