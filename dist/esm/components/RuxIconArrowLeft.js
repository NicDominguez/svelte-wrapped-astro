...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_arrow_left = element("rux-icon-arrow-left");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_arrow_left, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_arrow_left, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_arrow_left, anchor);
            if (default_slot) {
...
class RuxIconArrowLeft extends SvelteComponent {
    constructor(options) {
        super();
