...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_wb_sunny = element("rux-icon-wb-sunny");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_wb_sunny, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_wb_sunny, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_wb_sunny, anchor);
            if (default_slot) {
...
class RuxIconWbSunny extends SvelteComponent {
    constructor(options) {
        super();
