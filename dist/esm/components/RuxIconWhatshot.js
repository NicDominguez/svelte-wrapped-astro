...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_whatshot = element("rux-icon-whatshot");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_whatshot, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_whatshot, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_whatshot, anchor);
            if (default_slot) {
...
class RuxIconWhatshot extends SvelteComponent {
    constructor(options) {
        super();
