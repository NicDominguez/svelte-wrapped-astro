...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_battery_60 = element("rux-icon-battery-60");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_battery_60, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_battery_60, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_battery_60, anchor);
            if (default_slot) {
...
class RuxIconBattery60 extends SvelteComponent {
    constructor(options) {
        super();
