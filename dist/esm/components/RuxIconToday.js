...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_today = element("rux-icon-today");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_today, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_today, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_today, anchor);
            if (default_slot) {
...
class RuxIconToday extends SvelteComponent {
    constructor(options) {
        super();
