...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_phonelink = element("rux-icon-phonelink");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_phonelink, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_phonelink, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_phonelink, anchor);
            if (default_slot) {
...
class RuxIconPhonelink extends SvelteComponent {
    constructor(options) {
        super();
