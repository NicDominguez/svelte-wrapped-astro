...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_backspace = element("rux-icon-backspace");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_backspace, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_backspace, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_backspace, anchor);
            if (default_slot) {
...
class RuxIconBackspace extends SvelteComponent {
    constructor(options) {
        super();
