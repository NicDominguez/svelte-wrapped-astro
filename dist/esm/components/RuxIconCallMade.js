...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_call_made = element("rux-icon-call-made");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_call_made, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_call_made, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_call_made, anchor);
            if (default_slot) {
...
class RuxIconCallMade extends SvelteComponent {
    constructor(options) {
        super();
