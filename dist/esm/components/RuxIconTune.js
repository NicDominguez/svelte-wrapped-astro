...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_tune = element("rux-icon-tune");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_tune, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_tune, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_tune, anchor);
            if (default_slot) {
...
class RuxIconTune extends SvelteComponent {
    constructor(options) {
        super();
