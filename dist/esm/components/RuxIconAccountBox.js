...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_account_box = element("rux-icon-account-box");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_account_box, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_account_box, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_account_box, anchor);
            if (default_slot) {
...
class RuxIconAccountBox extends SvelteComponent {
    constructor(options) {
        super();
