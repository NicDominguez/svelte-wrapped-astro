...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_movie = element("rux-icon-movie");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_movie, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_movie, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_movie, anchor);
            if (default_slot) {
...
class RuxIconMovie extends SvelteComponent {
    constructor(options) {
        super();
