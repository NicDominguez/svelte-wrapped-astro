...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_nfc = element("rux-icon-nfc");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_nfc, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_nfc, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_nfc, anchor);
            if (default_slot) {
...
class RuxIconNfc extends SvelteComponent {
    constructor(options) {
        super();
