...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_stars = element("rux-icon-stars");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_stars, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_stars, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_stars, anchor);
            if (default_slot) {
...
class RuxIconStars extends SvelteComponent {
    constructor(options) {
        super();
