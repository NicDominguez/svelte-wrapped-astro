...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_shop = element("rux-icon-shop");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_shop, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_shop, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_shop, anchor);
            if (default_slot) {
...
class RuxIconShop extends SvelteComponent {
    constructor(options) {
        super();
