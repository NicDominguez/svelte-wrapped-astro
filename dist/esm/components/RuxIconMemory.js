...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_memory = element("rux-icon-memory");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_memory, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_memory, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_memory, anchor);
            if (default_slot) {
...
class RuxIconMemory extends SvelteComponent {
    constructor(options) {
        super();
