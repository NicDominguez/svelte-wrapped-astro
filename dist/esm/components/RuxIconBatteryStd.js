...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_battery_std = element("rux-icon-battery-std");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_battery_std, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_battery_std, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_battery_std, anchor);
            if (default_slot) {
...
class RuxIconBatteryStd extends SvelteComponent {
    constructor(options) {
        super();
