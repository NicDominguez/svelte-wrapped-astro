...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_unfold_more = element("rux-icon-unfold-more");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_unfold_more, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_unfold_more, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_unfold_more, anchor);
            if (default_slot) {
...
class RuxIconUnfoldMore extends SvelteComponent {
    constructor(options) {
        super();
