...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_update = element("rux-icon-update");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_update, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_update, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_update, anchor);
            if (default_slot) {
...
class RuxIconUpdate extends SvelteComponent {
    constructor(options) {
        super();
