...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_headset = element("rux-icon-headset");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_headset, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_headset, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_headset, anchor);
            if (default_slot) {
...
class RuxIconHeadset extends SvelteComponent {
    constructor(options) {
        super();
