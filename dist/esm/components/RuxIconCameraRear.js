...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_camera_rear = element("rux-icon-camera-rear");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_camera_rear, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_camera_rear, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_camera_rear, anchor);
            if (default_slot) {
...
class RuxIconCameraRear extends SvelteComponent {
    constructor(options) {
        super();
