...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_maximize = element("rux-icon-maximize");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_maximize, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_maximize, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_maximize, anchor);
            if (default_slot) {
...
class RuxIconMaximize extends SvelteComponent {
    constructor(options) {
        super();
