...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_star = element("rux-icon-star");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_star, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_star, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_star, anchor);
            if (default_slot) {
...
class RuxIconStar extends SvelteComponent {
    constructor(options) {
        super();
