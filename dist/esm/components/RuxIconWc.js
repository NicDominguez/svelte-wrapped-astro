...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_wc = element("rux-icon-wc");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_wc, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_wc, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_wc, anchor);
            if (default_slot) {
...
class RuxIconWc extends SvelteComponent {
    constructor(options) {
        super();
