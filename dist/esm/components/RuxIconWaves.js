...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_waves = element("rux-icon-waves");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_waves, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_waves, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_waves, anchor);
            if (default_slot) {
...
class RuxIconWaves extends SvelteComponent {
    constructor(options) {
        super();
