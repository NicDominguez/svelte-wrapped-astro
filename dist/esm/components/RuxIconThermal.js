...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_thermal = element("rux-icon-thermal");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_thermal, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_thermal, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_thermal, anchor);
            if (default_slot) {
...
class RuxIconThermal extends SvelteComponent {
    constructor(options) {
        super();
