...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_landscape = element("rux-icon-landscape");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_landscape, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_landscape, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_landscape, anchor);
            if (default_slot) {
...
class RuxIconLandscape extends SvelteComponent {
    constructor(options) {
        super();
