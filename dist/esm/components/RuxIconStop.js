...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_stop = element("rux-icon-stop");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_stop, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_stop, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_stop, anchor);
            if (default_slot) {
...
class RuxIconStop extends SvelteComponent {
    constructor(options) {
        super();
