...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_looks_6 = element("rux-icon-looks-6");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_looks_6, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_looks_6, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_looks_6, anchor);
            if (default_slot) {
...
class RuxIconLooks6 extends SvelteComponent {
    constructor(options) {
        super();
