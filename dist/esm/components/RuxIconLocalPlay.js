...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_play = element("rux-icon-local-play");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_play, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_play, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_play, anchor);
            if (default_slot) {
...
class RuxIconLocalPlay extends SvelteComponent {
    constructor(options) {
        super();
