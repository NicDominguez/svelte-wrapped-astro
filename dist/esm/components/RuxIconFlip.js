...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_flip = element("rux-icon-flip");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_flip, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_flip, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_flip, anchor);
            if (default_slot) {
...
class RuxIconFlip extends SvelteComponent {
    constructor(options) {
        super();
