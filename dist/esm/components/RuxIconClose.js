...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_close = element("rux-icon-close");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_close, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_close, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_close, anchor);
            if (default_slot) {
...
class RuxIconClose extends SvelteComponent {
    constructor(options) {
        super();
