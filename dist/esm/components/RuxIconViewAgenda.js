...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_agenda = element("rux-icon-view-agenda");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_agenda, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_agenda, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_agenda, anchor);
            if (default_slot) {
...
class RuxIconViewAgenda extends SvelteComponent {
    constructor(options) {
        super();
