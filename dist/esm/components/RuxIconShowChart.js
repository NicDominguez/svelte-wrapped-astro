...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_show_chart = element("rux-icon-show-chart");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_show_chart, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_show_chart, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_show_chart, anchor);
            if (default_slot) {
...
class RuxIconShowChart extends SvelteComponent {
    constructor(options) {
        super();
