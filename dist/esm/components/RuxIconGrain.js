...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_grain = element("rux-icon-grain");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_grain, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_grain, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_grain, anchor);
            if (default_slot) {
...
class RuxIconGrain extends SvelteComponent {
    constructor(options) {
        super();
