...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_gamepad = element("rux-icon-gamepad");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_gamepad, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_gamepad, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_gamepad, anchor);
            if (default_slot) {
...
class RuxIconGamepad extends SvelteComponent {
    constructor(options) {
        super();
