...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_toggle_on = element("rux-icon-toggle-on");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_toggle_on, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_toggle_on, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_toggle_on, anchor);
            if (default_slot) {
...
class RuxIconToggleOn extends SvelteComponent {
    constructor(options) {
        super();
