...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_theaters = element("rux-icon-theaters");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_theaters, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_theaters, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_theaters, anchor);
            if (default_slot) {
...
class RuxIconTheaters extends SvelteComponent {
    constructor(options) {
        super();
