...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_line_weight = element("rux-icon-line-weight");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_line_weight, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_line_weight, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_line_weight, anchor);
            if (default_slot) {
...
class RuxIconLineWeight extends SvelteComponent {
    constructor(options) {
        super();
