...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_volume_mute = element("rux-icon-volume-mute");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_volume_mute, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_volume_mute, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_volume_mute, anchor);
            if (default_slot) {
...
class RuxIconVolumeMute extends SvelteComponent {
    constructor(options) {
        super();
