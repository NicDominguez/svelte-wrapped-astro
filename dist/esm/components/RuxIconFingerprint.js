...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_fingerprint = element("rux-icon-fingerprint");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_fingerprint, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_fingerprint, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_fingerprint, anchor);
            if (default_slot) {
...
class RuxIconFingerprint extends SvelteComponent {
    constructor(options) {
        super();
