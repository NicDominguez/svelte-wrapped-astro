...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_loupe = element("rux-icon-loupe");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_loupe, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_loupe, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_loupe, anchor);
            if (default_slot) {
...
class RuxIconLoupe extends SvelteComponent {
    constructor(options) {
        super();
