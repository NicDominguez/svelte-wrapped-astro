...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_restaurant = element("rux-icon-restaurant");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_restaurant, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_restaurant, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_restaurant, anchor);
            if (default_slot) {
...
class RuxIconRestaurant extends SvelteComponent {
    constructor(options) {
        super();
