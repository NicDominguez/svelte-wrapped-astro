...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_all_inbox = element("rux-icon-all-inbox");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_all_inbox, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_all_inbox, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_all_inbox, anchor);
            if (default_slot) {
...
class RuxIconAllInbox extends SvelteComponent {
    constructor(options) {
        super();
