...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_3d_rotation = element("rux-icon-3d-rotation");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_3d_rotation, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_3d_rotation, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_3d_rotation, anchor);
            if (default_slot) {
...
class RuxIcon3dRotation extends SvelteComponent {
    constructor(options) {
        super();
