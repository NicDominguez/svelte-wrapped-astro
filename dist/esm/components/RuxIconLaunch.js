...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_launch = element("rux-icon-launch");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_launch, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_launch, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_launch, anchor);
            if (default_slot) {
...
class RuxIconLaunch extends SvelteComponent {
    constructor(options) {
        super();
