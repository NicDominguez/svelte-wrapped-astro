...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_dns = element("rux-icon-dns");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_dns, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_dns, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_dns, anchor);
            if (default_slot) {
...
class RuxIconDns extends SvelteComponent {
    constructor(options) {
        super();
