...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_16_9 = element("rux-icon-crop-16-9");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_crop_16_9, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_crop_16_9, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_crop_16_9, anchor);
            if (default_slot) {
...
class RuxIconCrop169 extends SvelteComponent {
    constructor(options) {
        super();
