...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_how_to_vote = element("rux-icon-how-to-vote");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_how_to_vote, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_how_to_vote, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_how_to_vote, anchor);
            if (default_slot) {
...
class RuxIconHowToVote extends SvelteComponent {
    constructor(options) {
        super();
