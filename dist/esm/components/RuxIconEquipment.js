...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_equipment = element("rux-icon-equipment");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_equipment, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_equipment, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_equipment, anchor);
            if (default_slot) {
...
class RuxIconEquipment extends SvelteComponent {
    constructor(options) {
        super();
