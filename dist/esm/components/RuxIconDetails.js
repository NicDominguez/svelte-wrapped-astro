...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_details = element("rux-icon-details");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_details, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_details, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_details, anchor);
            if (default_slot) {
...
class RuxIconDetails extends SvelteComponent {
    constructor(options) {
        super();
