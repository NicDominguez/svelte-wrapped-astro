...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_battery_80 = element("rux-icon-battery-80");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_battery_80, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_battery_80, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_battery_80, anchor);
            if (default_slot) {
...
class RuxIconBattery80 extends SvelteComponent {
    constructor(options) {
        super();
