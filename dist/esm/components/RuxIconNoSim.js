...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_no_sim = element("rux-icon-no-sim");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_no_sim, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_no_sim, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_no_sim, anchor);
            if (default_slot) {
...
class RuxIconNoSim extends SvelteComponent {
    constructor(options) {
        super();
