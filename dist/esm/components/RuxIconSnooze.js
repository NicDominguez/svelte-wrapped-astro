...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_snooze = element("rux-icon-snooze");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_snooze, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_snooze, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_snooze, anchor);
            if (default_slot) {
...
class RuxIconSnooze extends SvelteComponent {
    constructor(options) {
        super();
