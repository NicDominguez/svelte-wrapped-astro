...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_open_in_new = element("rux-icon-open-in-new");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_open_in_new, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_open_in_new, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_open_in_new, anchor);
            if (default_slot) {
...
class RuxIconOpenInNew extends SvelteComponent {
    constructor(options) {
        super();
