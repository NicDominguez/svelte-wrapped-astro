...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_border_left = element("rux-icon-border-left");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_border_left, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_border_left, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_border_left, anchor);
            if (default_slot) {
...
class RuxIconBorderLeft extends SvelteComponent {
    constructor(options) {
        super();
