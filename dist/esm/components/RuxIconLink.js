...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_link = element("rux-icon-link");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_link, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_link, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_link, anchor);
            if (default_slot) {
...
class RuxIconLink extends SvelteComponent {
    constructor(options) {
        super();
