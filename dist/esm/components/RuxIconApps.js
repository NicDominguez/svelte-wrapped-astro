...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_apps = element("rux-icon-apps");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_apps, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_apps, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_apps, anchor);
            if (default_slot) {
...
class RuxIconApps extends SvelteComponent {
    constructor(options) {
        super();
