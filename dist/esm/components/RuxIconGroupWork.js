...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_group_work = element("rux-icon-group-work");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_group_work, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_group_work, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_group_work, anchor);
            if (default_slot) {
...
class RuxIconGroupWork extends SvelteComponent {
    constructor(options) {
        super();
