...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_format_bold = element("rux-icon-format-bold");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_format_bold, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_format_bold, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_format_bold, anchor);
            if (default_slot) {
...
class RuxIconFormatBold extends SvelteComponent {
    constructor(options) {
        super();
