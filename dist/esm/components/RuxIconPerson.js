...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_person = element("rux-icon-person");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_person, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_person, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_person, anchor);
            if (default_slot) {
...
class RuxIconPerson extends SvelteComponent {
    constructor(options) {
        super();
