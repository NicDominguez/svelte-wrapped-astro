...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_portrait = element("rux-icon-portrait");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_portrait, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_portrait, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_portrait, anchor);
            if (default_slot) {
...
class RuxIconPortrait extends SvelteComponent {
    constructor(options) {
        super();
