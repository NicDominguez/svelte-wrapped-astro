...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_voice_chat = element("rux-icon-voice-chat");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_voice_chat, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_voice_chat, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_voice_chat, anchor);
            if (default_slot) {
...
class RuxIconVoiceChat extends SvelteComponent {
    constructor(options) {
        super();
