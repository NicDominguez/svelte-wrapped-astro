...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_timeline = element("rux-icon-timeline");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_timeline, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_timeline, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_timeline, anchor);
            if (default_slot) {
...
class RuxIconTimeline extends SvelteComponent {
    constructor(options) {
        super();
