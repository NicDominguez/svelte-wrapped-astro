...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_functions = element("rux-icon-functions");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_functions, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_functions, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_functions, anchor);
            if (default_slot) {
...
class RuxIconFunctions extends SvelteComponent {
    constructor(options) {
        super();
