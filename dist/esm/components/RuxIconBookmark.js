...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_bookmark = element("rux-icon-bookmark");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_bookmark, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_bookmark, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_bookmark, anchor);
            if (default_slot) {
...
class RuxIconBookmark extends SvelteComponent {
    constructor(options) {
        super();
