...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_my_location = element("rux-icon-my-location");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_my_location, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_my_location, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_my_location, anchor);
            if (default_slot) {
...
class RuxIconMyLocation extends SvelteComponent {
    constructor(options) {
        super();
