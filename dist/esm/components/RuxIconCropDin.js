...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_crop_din = element("rux-icon-crop-din");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_crop_din, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_crop_din, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_crop_din, anchor);
            if (default_slot) {
...
class RuxIconCropDin extends SvelteComponent {
    constructor(options) {
        super();
