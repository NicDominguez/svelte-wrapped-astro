...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_layers = element("rux-icon-layers");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_layers, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_layers, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_layers, anchor);
            if (default_slot) {
...
class RuxIconLayers extends SvelteComponent {
    constructor(options) {
        super();
