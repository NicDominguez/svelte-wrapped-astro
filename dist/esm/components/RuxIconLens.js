...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_lens = element("rux-icon-lens");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_lens, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_lens, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_lens, anchor);
            if (default_slot) {
...
class RuxIconLens extends SvelteComponent {
    constructor(options) {
        super();
