...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_wrap_text = element("rux-icon-wrap-text");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_wrap_text, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_wrap_text, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_wrap_text, anchor);
            if (default_slot) {
...
class RuxIconWrapText extends SvelteComponent {
    constructor(options) {
        super();
