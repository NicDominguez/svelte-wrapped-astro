...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_call = element("rux-icon-call");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_call, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_call, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_call, anchor);
            if (default_slot) {
...
class RuxIconCall extends SvelteComponent {
    constructor(options) {
        super();
