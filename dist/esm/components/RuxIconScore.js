...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_score = element("rux-icon-score");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_score, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_score, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_score, anchor);
            if (default_slot) {
...
class RuxIconScore extends SvelteComponent {
    constructor(options) {
        super();
