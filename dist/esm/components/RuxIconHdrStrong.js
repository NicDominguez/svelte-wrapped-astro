...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_hdr_strong = element("rux-icon-hdr-strong");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_hdr_strong, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_hdr_strong, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_hdr_strong, anchor);
            if (default_slot) {
...
class RuxIconHdrStrong extends SvelteComponent {
    constructor(options) {
        super();
