...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cell_wifi = element("rux-icon-cell-wifi");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_cell_wifi, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_cell_wifi, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_cell_wifi, anchor);
            if (default_slot) {
...
class RuxIconCellWifi extends SvelteComponent {
    constructor(options) {
        super();
