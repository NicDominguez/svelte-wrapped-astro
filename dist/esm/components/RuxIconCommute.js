...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_commute = element("rux-icon-commute");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_commute, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_commute, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_commute, anchor);
            if (default_slot) {
...
class RuxIconCommute extends SvelteComponent {
    constructor(options) {
        super();
