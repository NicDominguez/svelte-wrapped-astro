...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_expand_more = element("rux-icon-expand-more");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_expand_more, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_expand_more, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_expand_more, anchor);
            if (default_slot) {
...
class RuxIconExpandMore extends SvelteComponent {
    constructor(options) {
        super();
