...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_trending_up = element("rux-icon-trending-up");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_trending_up, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_trending_up, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_trending_up, anchor);
            if (default_slot) {
...
class RuxIconTrendingUp extends SvelteComponent {
    constructor(options) {
        super();
