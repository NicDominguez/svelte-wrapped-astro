...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_image = element("rux-icon-image");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_image, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_image, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_image, anchor);
            if (default_slot) {
...
class RuxIconImage extends SvelteComponent {
    constructor(options) {
        super();
