...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_vpn_key = element("rux-icon-vpn-key");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_vpn_key, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_vpn_key, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_vpn_key, anchor);
            if (default_slot) {
...
class RuxIconVpnKey extends SvelteComponent {
    constructor(options) {
        super();
