...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_smartphone = element("rux-icon-smartphone");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_smartphone, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_smartphone, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_smartphone, anchor);
            if (default_slot) {
...
class RuxIconSmartphone extends SvelteComponent {
    constructor(options) {
        super();
