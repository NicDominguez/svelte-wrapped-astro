...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_live_help = element("rux-icon-live-help");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_live_help, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_live_help, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_live_help, anchor);
            if (default_slot) {
...
class RuxIconLiveHelp extends SvelteComponent {
    constructor(options) {
        super();
