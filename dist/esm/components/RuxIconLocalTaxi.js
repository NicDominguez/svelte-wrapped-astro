...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_taxi = element("rux-icon-local-taxi");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_taxi, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_taxi, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_taxi, anchor);
            if (default_slot) {
...
class RuxIconLocalTaxi extends SvelteComponent {
    constructor(options) {
        super();
