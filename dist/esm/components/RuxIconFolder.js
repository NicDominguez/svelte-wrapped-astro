...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_folder = element("rux-icon-folder");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_folder, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_folder, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_folder, anchor);
            if (default_slot) {
...
class RuxIconFolder extends SvelteComponent {
    constructor(options) {
        super();
