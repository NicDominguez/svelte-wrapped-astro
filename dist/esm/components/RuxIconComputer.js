...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_computer = element("rux-icon-computer");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_computer, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_computer, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_computer, anchor);
            if (default_slot) {
...
class RuxIconComputer extends SvelteComponent {
    constructor(options) {
        super();
