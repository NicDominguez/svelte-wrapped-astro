...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_solar = element("rux-icon-solar");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_solar, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_solar, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_solar, anchor);
            if (default_slot) {
...
class RuxIconSolar extends SvelteComponent {
    constructor(options) {
        super();
