...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_flight = element("rux-icon-flight");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_flight, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_flight, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_flight, anchor);
            if (default_slot) {
...
class RuxIconFlight extends SvelteComponent {
    constructor(options) {
        super();
