...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_restore = element("rux-icon-restore");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_restore, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_restore, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_restore, anchor);
            if (default_slot) {
...
class RuxIconRestore extends SvelteComponent {
    constructor(options) {
        super();
