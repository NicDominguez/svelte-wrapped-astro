...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_slideshow = element("rux-icon-slideshow");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_slideshow, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_slideshow, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_slideshow, anchor);
            if (default_slot) {
...
class RuxIconSlideshow extends SvelteComponent {
    constructor(options) {
        super();
