...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_zoom_out = element("rux-icon-zoom-out");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_zoom_out, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_zoom_out, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_zoom_out, anchor);
            if (default_slot) {
...
class RuxIconZoomOut extends SvelteComponent {
    constructor(options) {
        super();
