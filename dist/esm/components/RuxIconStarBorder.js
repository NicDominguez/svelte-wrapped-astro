...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_star_border = element("rux-icon-star-border");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_star_border, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_star_border, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_star_border, anchor);
            if (default_slot) {
...
class RuxIconStarBorder extends SvelteComponent {
    constructor(options) {
        super();
