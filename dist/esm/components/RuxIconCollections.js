...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_collections = element("rux-icon-collections");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_collections, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_collections, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_collections, anchor);
            if (default_slot) {
...
class RuxIconCollections extends SvelteComponent {
    constructor(options) {
        super();
