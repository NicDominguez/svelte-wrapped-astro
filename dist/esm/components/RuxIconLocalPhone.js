...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_phone = element("rux-icon-local-phone");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_phone, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_phone, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_phone, anchor);
            if (default_slot) {
...
class RuxIconLocalPhone extends SvelteComponent {
    constructor(options) {
        super();
