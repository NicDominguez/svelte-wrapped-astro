...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_assignment = element("rux-icon-assignment");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_assignment, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_assignment, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_assignment, anchor);
            if (default_slot) {
...
class RuxIconAssignment extends SvelteComponent {
    constructor(options) {
        super();
