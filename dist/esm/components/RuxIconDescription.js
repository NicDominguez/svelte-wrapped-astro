...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_description = element("rux-icon-description");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_description, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_description, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_description, anchor);
            if (default_slot) {
...
class RuxIconDescription extends SvelteComponent {
    constructor(options) {
        super();
