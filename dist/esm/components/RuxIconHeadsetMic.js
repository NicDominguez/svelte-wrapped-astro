...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_headset_mic = element("rux-icon-headset-mic");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_headset_mic, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_headset_mic, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_headset_mic, anchor);
            if (default_slot) {
...
class RuxIconHeadsetMic extends SvelteComponent {
    constructor(options) {
        super();
