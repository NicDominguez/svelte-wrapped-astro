...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_done = element("rux-icon-done");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_done, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_done, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_done, anchor);
            if (default_slot) {
...
class RuxIconDone extends SvelteComponent {
    constructor(options) {
        super();
