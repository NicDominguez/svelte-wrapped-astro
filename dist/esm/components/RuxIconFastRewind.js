...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_fast_rewind = element("rux-icon-fast-rewind");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_fast_rewind, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_fast_rewind, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_fast_rewind, anchor);
            if (default_slot) {
...
class RuxIconFastRewind extends SvelteComponent {
    constructor(options) {
        super();
