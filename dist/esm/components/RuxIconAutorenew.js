...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_autorenew = element("rux-icon-autorenew");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_autorenew, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_autorenew, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_autorenew, anchor);
            if (default_slot) {
...
class RuxIconAutorenew extends SvelteComponent {
    constructor(options) {
        super();
