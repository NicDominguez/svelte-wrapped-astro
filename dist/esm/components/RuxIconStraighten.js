...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_straighten = element("rux-icon-straighten");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_straighten, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_straighten, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_straighten, anchor);
            if (default_slot) {
...
class RuxIconStraighten extends SvelteComponent {
    constructor(options) {
        super();
