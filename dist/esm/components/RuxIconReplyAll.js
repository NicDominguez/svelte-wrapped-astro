...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_reply_all = element("rux-icon-reply-all");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_reply_all, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_reply_all, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_reply_all, anchor);
            if (default_slot) {
...
class RuxIconReplyAll extends SvelteComponent {
    constructor(options) {
        super();
