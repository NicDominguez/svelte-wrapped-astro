...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_mms = element("rux-icon-mms");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_mms, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_mms, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_mms, anchor);
            if (default_slot) {
...
class RuxIconMms extends SvelteComponent {
    constructor(options) {
        super();
