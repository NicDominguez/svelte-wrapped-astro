...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_voicemail = element("rux-icon-voicemail");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_voicemail, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_voicemail, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_voicemail, anchor);
            if (default_slot) {
...
class RuxIconVoicemail extends SvelteComponent {
    constructor(options) {
        super();
