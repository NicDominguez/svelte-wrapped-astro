...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_category = element("rux-icon-category");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_category, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_category, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_category, anchor);
            if (default_slot) {
...
class RuxIconCategory extends SvelteComponent {
    constructor(options) {
        super();
