...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_markunread = element("rux-icon-markunread");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_markunread, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_markunread, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_markunread, anchor);
            if (default_slot) {
...
class RuxIconMarkunread extends SvelteComponent {
    constructor(options) {
        super();
