...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_forward_5 = element("rux-icon-forward-5");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_forward_5, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_forward_5, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_forward_5, anchor);
            if (default_slot) {
...
class RuxIconForward5 extends SvelteComponent {
    constructor(options) {
        super();
