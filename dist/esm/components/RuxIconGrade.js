...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_grade = element("rux-icon-grade");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_grade, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_grade, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_grade, anchor);
            if (default_slot) {
...
class RuxIconGrade extends SvelteComponent {
    constructor(options) {
        super();
