...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_error = element("rux-icon-error");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_error, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_error, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_error, anchor);
            if (default_slot) {
...
class RuxIconError extends SvelteComponent {
    constructor(options) {
        super();
