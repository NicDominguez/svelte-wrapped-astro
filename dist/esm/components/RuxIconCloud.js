...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cloud = element("rux-icon-cloud");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_cloud, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_cloud, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_cloud, anchor);
            if (default_slot) {
...
class RuxIconCloud extends SvelteComponent {
    constructor(options) {
        super();
