...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_card_travel = element("rux-icon-card-travel");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_card_travel, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_card_travel, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_card_travel, anchor);
            if (default_slot) {
...
class RuxIconCardTravel extends SvelteComponent {
    constructor(options) {
        super();
