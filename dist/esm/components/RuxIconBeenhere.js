...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_beenhere = element("rux-icon-beenhere");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_beenhere, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_beenhere, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_beenhere, anchor);
            if (default_slot) {
...
class RuxIconBeenhere extends SvelteComponent {
    constructor(options) {
        super();
