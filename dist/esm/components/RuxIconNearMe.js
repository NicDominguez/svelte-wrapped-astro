...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_near_me = element("rux-icon-near-me");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_near_me, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_near_me, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_near_me, anchor);
            if (default_slot) {
...
class RuxIconNearMe extends SvelteComponent {
    constructor(options) {
        super();
