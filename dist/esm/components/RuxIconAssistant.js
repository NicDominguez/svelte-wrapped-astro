...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_assistant = element("rux-icon-assistant");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_assistant, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_assistant, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_assistant, anchor);
            if (default_slot) {
...
class RuxIconAssistant extends SvelteComponent {
    constructor(options) {
        super();
