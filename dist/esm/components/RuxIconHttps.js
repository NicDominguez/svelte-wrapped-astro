...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_https = element("rux-icon-https");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_https, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_https, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_https, anchor);
            if (default_slot) {
...
class RuxIconHttps extends SvelteComponent {
    constructor(options) {
        super();
