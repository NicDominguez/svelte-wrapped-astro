...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_laptop = element("rux-icon-laptop");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_laptop, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_laptop, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_laptop, anchor);
            if (default_slot) {
...
class RuxIconLaptop extends SvelteComponent {
    constructor(options) {
        super();
