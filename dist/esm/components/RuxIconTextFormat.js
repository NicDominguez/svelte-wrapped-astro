...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_text_format = element("rux-icon-text-format");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_text_format, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_text_format, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_text_format, anchor);
            if (default_slot) {
...
class RuxIconTextFormat extends SvelteComponent {
    constructor(options) {
        super();
