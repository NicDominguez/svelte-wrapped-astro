...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_radio = element("rux-icon-radio");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_radio, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_radio, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_radio, anchor);
            if (default_slot) {
...
class RuxIconRadio extends SvelteComponent {
    constructor(options) {
        super();
