...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_tram = element("rux-icon-tram");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_tram, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_tram, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_tram, anchor);
            if (default_slot) {
...
class RuxIconTram extends SvelteComponent {
    constructor(options) {
        super();
