...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_first_page = element("rux-icon-first-page");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_first_page, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_first_page, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_first_page, anchor);
            if (default_slot) {
...
class RuxIconFirstPage extends SvelteComponent {
    constructor(options) {
        super();
