...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_done_all = element("rux-icon-done-all");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_done_all, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_done_all, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_done_all, anchor);
            if (default_slot) {
...
class RuxIconDoneAll extends SvelteComponent {
    constructor(options) {
        super();
