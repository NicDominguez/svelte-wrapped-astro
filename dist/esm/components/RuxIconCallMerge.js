...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_call_merge = element("rux-icon-call-merge");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_call_merge, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_call_merge, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_call_merge, anchor);
            if (default_slot) {
...
class RuxIconCallMerge extends SvelteComponent {
    constructor(options) {
        super();
