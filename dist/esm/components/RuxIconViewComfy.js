...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_comfy = element("rux-icon-view-comfy");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_comfy, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_comfy, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_comfy, anchor);
            if (default_slot) {
...
class RuxIconViewComfy extends SvelteComponent {
    constructor(options) {
        super();
