...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_plus_one = element("rux-icon-plus-one");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_plus_one, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_plus_one, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_plus_one, anchor);
            if (default_slot) {
...
class RuxIconPlusOne extends SvelteComponent {
    constructor(options) {
        super();
