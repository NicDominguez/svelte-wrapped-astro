...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_loyalty = element("rux-icon-loyalty");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_loyalty, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_loyalty, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_loyalty, anchor);
            if (default_slot) {
...
class RuxIconLoyalty extends SvelteComponent {
    constructor(options) {
        super();
