...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_rowing = element("rux-icon-rowing");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_rowing, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_rowing, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_rowing, anchor);
            if (default_slot) {
...
class RuxIconRowing extends SvelteComponent {
    constructor(options) {
        super();
