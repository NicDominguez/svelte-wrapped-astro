...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_location_on = element("rux-icon-location-on");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_location_on, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_location_on, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_location_on, anchor);
            if (default_slot) {
...
class RuxIconLocationOn extends SvelteComponent {
    constructor(options) {
        super();
