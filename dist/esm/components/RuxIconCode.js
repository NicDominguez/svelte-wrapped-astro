...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_code = element("rux-icon-code");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_code, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_code, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_code, anchor);
            if (default_slot) {
...
class RuxIconCode extends SvelteComponent {
    constructor(options) {
        super();
