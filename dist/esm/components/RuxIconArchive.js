...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_archive = element("rux-icon-archive");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_archive, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_archive, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_archive, anchor);
            if (default_slot) {
...
class RuxIconArchive extends SvelteComponent {
    constructor(options) {
        super();
