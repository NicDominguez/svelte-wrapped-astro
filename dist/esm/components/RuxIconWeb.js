...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_web = element("rux-icon-web");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_web, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_web, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_web, anchor);
            if (default_slot) {
...
class RuxIconWeb extends SvelteComponent {
    constructor(options) {
        super();
