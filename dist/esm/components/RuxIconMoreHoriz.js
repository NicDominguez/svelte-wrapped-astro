...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_more_horiz = element("rux-icon-more-horiz");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_more_horiz, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_more_horiz, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_more_horiz, anchor);
            if (default_slot) {
...
class RuxIconMoreHoriz extends SvelteComponent {
    constructor(options) {
        super();
