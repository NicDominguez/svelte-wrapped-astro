...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_wb_cloudy = element("rux-icon-wb-cloudy");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_wb_cloudy, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_wb_cloudy, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_wb_cloudy, anchor);
            if (default_slot) {
...
class RuxIconWbCloudy extends SvelteComponent {
    constructor(options) {
        super();
