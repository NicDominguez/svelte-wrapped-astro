...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_poll = element("rux-icon-poll");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_poll, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_poll, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_poll, anchor);
            if (default_slot) {
...
class RuxIconPoll extends SvelteComponent {
    constructor(options) {
        super();
