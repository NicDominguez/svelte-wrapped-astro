...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_language = element("rux-icon-language");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_language, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_language, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_language, anchor);
            if (default_slot) {
...
class RuxIconLanguage extends SvelteComponent {
    constructor(options) {
        super();
