...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_loop = element("rux-icon-loop");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_loop, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_loop, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_loop, anchor);
            if (default_slot) {
...
class RuxIconLoop extends SvelteComponent {
    constructor(options) {
        super();
