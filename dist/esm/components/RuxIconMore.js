...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_more = element("rux-icon-more");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_more, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_more, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_more, anchor);
            if (default_slot) {
...
class RuxIconMore extends SvelteComponent {
    constructor(options) {
        super();
