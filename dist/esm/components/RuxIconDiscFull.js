...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_disc_full = element("rux-icon-disc-full");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_disc_full, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_disc_full, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_disc_full, anchor);
            if (default_slot) {
...
class RuxIconDiscFull extends SvelteComponent {
    constructor(options) {
        super();
