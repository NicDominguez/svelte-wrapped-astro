...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_blur_linear = element("rux-icon-blur-linear");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_blur_linear, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_blur_linear, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_blur_linear, anchor);
            if (default_slot) {
...
class RuxIconBlurLinear extends SvelteComponent {
    constructor(options) {
        super();
