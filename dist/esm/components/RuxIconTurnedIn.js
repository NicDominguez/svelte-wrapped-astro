...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_turned_in = element("rux-icon-turned-in");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_turned_in, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_turned_in, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_turned_in, anchor);
            if (default_slot) {
...
class RuxIconTurnedIn extends SvelteComponent {
    constructor(options) {
        super();
