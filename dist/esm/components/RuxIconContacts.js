...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_contacts = element("rux-icon-contacts");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_contacts, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_contacts, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_contacts, anchor);
            if (default_slot) {
...
class RuxIconContacts extends SvelteComponent {
    constructor(options) {
        super();
