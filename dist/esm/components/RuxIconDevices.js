...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_devices = element("rux-icon-devices");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_devices, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_devices, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_devices, anchor);
            if (default_slot) {
...
class RuxIconDevices extends SvelteComponent {
    constructor(options) {
        super();
