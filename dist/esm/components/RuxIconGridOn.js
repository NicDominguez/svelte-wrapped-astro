...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_grid_on = element("rux-icon-grid-on");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_grid_on, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_grid_on, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_grid_on, anchor);
            if (default_slot) {
...
class RuxIconGridOn extends SvelteComponent {
    constructor(options) {
        super();
