...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_widgets = element("rux-icon-widgets");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_widgets, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_widgets, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_widgets, anchor);
            if (default_slot) {
...
class RuxIconWidgets extends SvelteComponent {
    constructor(options) {
        super();
