...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_event_busy = element("rux-icon-event-busy");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_event_busy, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_event_busy, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_event_busy, anchor);
            if (default_slot) {
...
class RuxIconEventBusy extends SvelteComponent {
    constructor(options) {
        super();
