...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_swap_vert = element("rux-icon-swap-vert");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_swap_vert, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_swap_vert, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_swap_vert, anchor);
            if (default_slot) {
...
class RuxIconSwapVert extends SvelteComponent {
    constructor(options) {
        super();
