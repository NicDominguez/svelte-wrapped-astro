...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_reply = element("rux-icon-reply");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_reply, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_reply, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_reply, anchor);
            if (default_slot) {
...
class RuxIconReply extends SvelteComponent {
    constructor(options) {
        super();
