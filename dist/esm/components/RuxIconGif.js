...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_gif = element("rux-icon-gif");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_gif, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_gif, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_gif, anchor);
            if (default_slot) {
...
class RuxIconGif extends SvelteComponent {
    constructor(options) {
        super();
