...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_watch = element("rux-icon-watch");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_watch, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_watch, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_watch, anchor);
            if (default_slot) {
...
class RuxIconWatch extends SvelteComponent {
    constructor(options) {
        super();
