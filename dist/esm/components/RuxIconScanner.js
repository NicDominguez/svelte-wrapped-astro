...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_scanner = element("rux-icon-scanner");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_scanner, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_scanner, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_scanner, anchor);
            if (default_slot) {
...
class RuxIconScanner extends SvelteComponent {
    constructor(options) {
        super();
