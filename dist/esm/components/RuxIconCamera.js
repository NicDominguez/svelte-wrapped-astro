...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_camera = element("rux-icon-camera");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_camera, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_camera, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_camera, anchor);
            if (default_slot) {
...
class RuxIconCamera extends SvelteComponent {
    constructor(options) {
        super();
