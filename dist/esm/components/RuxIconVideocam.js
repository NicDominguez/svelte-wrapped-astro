...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_videocam = element("rux-icon-videocam");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_videocam, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_videocam, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_videocam, anchor);
            if (default_slot) {
...
class RuxIconVideocam extends SvelteComponent {
    constructor(options) {
        super();
