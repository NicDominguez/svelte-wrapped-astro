...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_event = element("rux-icon-event");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_event, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_event, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_event, anchor);
            if (default_slot) {
...
class RuxIconEvent extends SvelteComponent {
    constructor(options) {
        super();
