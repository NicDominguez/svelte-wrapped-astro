...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_tonality = element("rux-icon-tonality");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_tonality, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_tonality, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_tonality, anchor);
            if (default_slot) {
...
class RuxIconTonality extends SvelteComponent {
    constructor(options) {
        super();
