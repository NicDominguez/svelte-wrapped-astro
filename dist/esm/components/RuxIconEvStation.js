...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_ev_station = element("rux-icon-ev-station");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_ev_station, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_ev_station, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_ev_station, anchor);
            if (default_slot) {
...
class RuxIconEvStation extends SvelteComponent {
    constructor(options) {
        super();
