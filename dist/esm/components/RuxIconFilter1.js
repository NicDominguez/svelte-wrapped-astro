...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_filter_1 = element("rux-icon-filter-1");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_filter_1, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_filter_1, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_filter_1, anchor);
            if (default_slot) {
...
class RuxIconFilter1 extends SvelteComponent {
    constructor(options) {
        super();
