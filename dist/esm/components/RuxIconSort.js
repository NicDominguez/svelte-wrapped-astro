...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sort = element("rux-icon-sort");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_sort, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_sort, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_sort, anchor);
            if (default_slot) {
...
class RuxIconSort extends SvelteComponent {
    constructor(options) {
        super();
