...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_shop_two = element("rux-icon-shop-two");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_shop_two, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_shop_two, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_shop_two, anchor);
            if (default_slot) {
...
class RuxIconShopTwo extends SvelteComponent {
    constructor(options) {
        super();
