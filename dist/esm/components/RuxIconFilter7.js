...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_filter_7 = element("rux-icon-filter-7");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_filter_7, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_filter_7, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_filter_7, anchor);
            if (default_slot) {
...
class RuxIconFilter7 extends SvelteComponent {
    constructor(options) {
        super();
