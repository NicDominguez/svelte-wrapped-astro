...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sd_storage = element("rux-icon-sd-storage");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_sd_storage, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_sd_storage, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_sd_storage, anchor);
            if (default_slot) {
...
class RuxIconSdStorage extends SvelteComponent {
    constructor(options) {
        super();
