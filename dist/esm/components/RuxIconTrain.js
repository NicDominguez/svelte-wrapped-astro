...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_train = element("rux-icon-train");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_train, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_train, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_train, anchor);
            if (default_slot) {
...
class RuxIconTrain extends SvelteComponent {
    constructor(options) {
        super();
