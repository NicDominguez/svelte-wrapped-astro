...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_vibration = element("rux-icon-vibration");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_vibration, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_vibration, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_vibration, anchor);
            if (default_slot) {
...
class RuxIconVibration extends SvelteComponent {
    constructor(options) {
        super();
