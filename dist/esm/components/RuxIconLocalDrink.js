...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_local_drink = element("rux-icon-local-drink");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_local_drink, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_local_drink, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_local_drink, anchor);
            if (default_slot) {
...
class RuxIconLocalDrink extends SvelteComponent {
    constructor(options) {
        super();
