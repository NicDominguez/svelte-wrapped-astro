...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_party_mode = element("rux-icon-party-mode");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_party_mode, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_party_mode, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_party_mode, anchor);
            if (default_slot) {
...
class RuxIconPartyMode extends SvelteComponent {
    constructor(options) {
        super();
