...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_redo = element("rux-icon-redo");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_redo, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_redo, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_redo, anchor);
            if (default_slot) {
...
class RuxIconRedo extends SvelteComponent {
    constructor(options) {
        super();
