...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_domain = element("rux-icon-domain");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_domain, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_domain, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_domain, anchor);
            if (default_slot) {
...
class RuxIconDomain extends SvelteComponent {
    constructor(options) {
        super();
