...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_border_top = element("rux-icon-border-top");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_border_top, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_border_top, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_border_top, anchor);
            if (default_slot) {
...
class RuxIconBorderTop extends SvelteComponent {
    constructor(options) {
        super();
