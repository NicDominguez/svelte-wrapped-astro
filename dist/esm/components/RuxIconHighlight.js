...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_highlight = element("rux-icon-highlight");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_highlight, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_highlight, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_highlight, anchor);
            if (default_slot) {
...
class RuxIconHighlight extends SvelteComponent {
    constructor(options) {
        super();
