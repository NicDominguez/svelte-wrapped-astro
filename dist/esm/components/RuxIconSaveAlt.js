...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_save_alt = element("rux-icon-save-alt");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_save_alt, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_save_alt, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_save_alt, anchor);
            if (default_slot) {
...
class RuxIconSaveAlt extends SvelteComponent {
    constructor(options) {
        super();
