...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sync = element("rux-icon-sync");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_sync, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_sync, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_sync, anchor);
            if (default_slot) {
...
class RuxIconSync extends SvelteComponent {
    constructor(options) {
        super();
