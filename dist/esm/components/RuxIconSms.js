...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sms = element("rux-icon-sms");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_sms, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_sms, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_sms, anchor);
            if (default_slot) {
...
class RuxIconSms extends SvelteComponent {
    constructor(options) {
        super();
