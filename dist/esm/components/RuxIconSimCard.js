...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sim_card = element("rux-icon-sim-card");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_sim_card, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_sim_card, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_sim_card, anchor);
            if (default_slot) {
...
class RuxIconSimCard extends SvelteComponent {
    constructor(options) {
        super();
