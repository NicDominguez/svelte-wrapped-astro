...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_textsms = element("rux-icon-textsms");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_textsms, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_textsms, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_textsms, anchor);
            if (default_slot) {
...
class RuxIconTextsms extends SvelteComponent {
    constructor(options) {
        super();
