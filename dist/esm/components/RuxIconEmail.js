...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_email = element("rux-icon-email");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_email, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_email, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_email, anchor);
            if (default_slot) {
...
class RuxIconEmail extends SvelteComponent {
    constructor(options) {
        super();
