...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sd_card = element("rux-icon-sd-card");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_sd_card, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_sd_card, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_sd_card, anchor);
            if (default_slot) {
...
class RuxIconSdCard extends SvelteComponent {
    constructor(options) {
        super();
