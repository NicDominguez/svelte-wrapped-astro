...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_insert_link = element("rux-icon-insert-link");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_insert_link, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_insert_link, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_insert_link, anchor);
            if (default_slot) {
...
class RuxIconInsertLink extends SvelteComponent {
    constructor(options) {
        super();
