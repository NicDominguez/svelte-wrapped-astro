...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cake = element("rux-icon-cake");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_cake, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_cake, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_cake, anchor);
            if (default_slot) {
...
class RuxIconCake extends SvelteComponent {
    constructor(options) {
        super();
