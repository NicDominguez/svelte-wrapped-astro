...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_format_size = element("rux-icon-format-size");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_format_size, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_format_size, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_format_size, anchor);
            if (default_slot) {
...
class RuxIconFormatSize extends SvelteComponent {
    constructor(options) {
        super();
