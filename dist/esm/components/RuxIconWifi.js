...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_wifi = element("rux-icon-wifi");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_wifi, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_wifi, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_wifi, anchor);
            if (default_slot) {
...
class RuxIconWifi extends SvelteComponent {
    constructor(options) {
        super();
