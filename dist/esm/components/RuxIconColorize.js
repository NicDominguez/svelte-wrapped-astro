...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_colorize = element("rux-icon-colorize");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_colorize, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_colorize, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_colorize, anchor);
            if (default_slot) {
...
class RuxIconColorize extends SvelteComponent {
    constructor(options) {
        super();
