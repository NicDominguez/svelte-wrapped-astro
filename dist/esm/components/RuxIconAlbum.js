...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_album = element("rux-icon-album");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_album, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_album, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_album, anchor);
            if (default_slot) {
...
class RuxIconAlbum extends SvelteComponent {
    constructor(options) {
        super();
