...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_add_circle = element("rux-icon-add-circle");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_add_circle, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_add_circle, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_add_circle, anchor);
            if (default_slot) {
...
class RuxIconAddCircle extends SvelteComponent {
    constructor(options) {
        super();
