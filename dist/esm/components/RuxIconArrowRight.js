...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_arrow_right = element("rux-icon-arrow-right");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_arrow_right, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_arrow_right, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_arrow_right, anchor);
            if (default_slot) {
...
class RuxIconArrowRight extends SvelteComponent {
    constructor(options) {
        super();
