...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_sms_failed = element("rux-icon-sms-failed");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_sms_failed, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_sms_failed, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_sms_failed, anchor);
            if (default_slot) {
...
class RuxIconSmsFailed extends SvelteComponent {
    constructor(options) {
        super();
