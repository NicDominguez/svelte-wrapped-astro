...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_skip_next = element("rux-icon-skip-next");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_skip_next, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_skip_next, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_skip_next, anchor);
            if (default_slot) {
...
class RuxIconSkipNext extends SvelteComponent {
    constructor(options) {
        super();
