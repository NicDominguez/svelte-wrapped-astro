...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_call_missed = element("rux-icon-call-missed");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_call_missed, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_call_missed, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_call_missed, anchor);
            if (default_slot) {
...
class RuxIconCallMissed extends SvelteComponent {
    constructor(options) {
        super();
