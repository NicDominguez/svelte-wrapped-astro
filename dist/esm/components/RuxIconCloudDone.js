...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_cloud_done = element("rux-icon-cloud-done");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_cloud_done, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_cloud_done, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_cloud_done, anchor);
            if (default_slot) {
...
class RuxIconCloudDone extends SvelteComponent {
    constructor(options) {
        super();
