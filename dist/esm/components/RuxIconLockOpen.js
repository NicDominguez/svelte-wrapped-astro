...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_lock_open = element("rux-icon-lock-open");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_lock_open, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_lock_open, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_lock_open, anchor);
            if (default_slot) {
...
class RuxIconLockOpen extends SvelteComponent {
    constructor(options) {
        super();
