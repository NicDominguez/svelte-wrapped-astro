...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_gps_fixed = element("rux-icon-gps-fixed");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_gps_fixed, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_gps_fixed, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_gps_fixed, anchor);
            if (default_slot) {
...
class RuxIconGpsFixed extends SvelteComponent {
    constructor(options) {
        super();
