...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_print = element("rux-icon-print");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_print, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_print, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_print, anchor);
            if (default_slot) {
...
class RuxIconPrint extends SvelteComponent {
    constructor(options) {
        super();
