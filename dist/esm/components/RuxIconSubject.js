...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_subject = element("rux-icon-subject");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_subject, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_subject, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_subject, anchor);
            if (default_slot) {
...
class RuxIconSubject extends SvelteComponent {
    constructor(options) {
        super();
