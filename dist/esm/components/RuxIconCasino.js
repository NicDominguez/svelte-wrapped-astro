...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_casino = element("rux-icon-casino");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_casino, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_casino, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_casino, anchor);
            if (default_slot) {
...
class RuxIconCasino extends SvelteComponent {
    constructor(options) {
        super();
