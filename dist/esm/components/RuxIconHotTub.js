...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_hot_tub = element("rux-icon-hot-tub");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_hot_tub, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_hot_tub, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_hot_tub, anchor);
            if (default_slot) {
...
class RuxIconHotTub extends SvelteComponent {
    constructor(options) {
        super();
