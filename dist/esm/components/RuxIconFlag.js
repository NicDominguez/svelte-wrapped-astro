...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_flag = element("rux-icon-flag");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_flag, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_flag, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_flag, anchor);
            if (default_slot) {
...
class RuxIconFlag extends SvelteComponent {
    constructor(options) {
        super();
