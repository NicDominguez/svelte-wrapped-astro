...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_receipt = element("rux-icon-receipt");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_receipt, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_receipt, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_receipt, anchor);
            if (default_slot) {
...
class RuxIconReceipt extends SvelteComponent {
    constructor(options) {
        super();
