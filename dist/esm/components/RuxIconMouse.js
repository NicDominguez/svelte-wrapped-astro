...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_mouse = element("rux-icon-mouse");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_mouse, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_mouse, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_mouse, anchor);
            if (default_slot) {
...
class RuxIconMouse extends SvelteComponent {
    constructor(options) {
        super();
