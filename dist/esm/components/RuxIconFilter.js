...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_filter = element("rux-icon-filter");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_filter, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_filter, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_filter, anchor);
            if (default_slot) {
...
class RuxIconFilter extends SvelteComponent {
    constructor(options) {
        super();
