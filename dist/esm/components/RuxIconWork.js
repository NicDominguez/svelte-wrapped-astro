...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_work = element("rux-icon-work");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_work, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_work, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_work, anchor);
            if (default_slot) {
...
class RuxIconWork extends SvelteComponent {
    constructor(options) {
        super();
