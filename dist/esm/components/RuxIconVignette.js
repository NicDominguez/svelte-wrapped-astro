...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_vignette = element("rux-icon-vignette");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_vignette, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_vignette, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_vignette, anchor);
            if (default_slot) {
...
class RuxIconVignette extends SvelteComponent {
    constructor(options) {
        super();
