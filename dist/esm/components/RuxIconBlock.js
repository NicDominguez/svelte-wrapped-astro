...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_block = element("rux-icon-block");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_block, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_block, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_block, anchor);
            if (default_slot) {
...
class RuxIconBlock extends SvelteComponent {
    constructor(options) {
        super();
