...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_satellite = element("rux-icon-satellite");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_satellite, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_satellite, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_satellite, anchor);
            if (default_slot) {
...
class RuxIconSatellite extends SvelteComponent {
    constructor(options) {
        super();
