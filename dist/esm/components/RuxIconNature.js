...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_nature = element("rux-icon-nature");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_nature, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_nature, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_nature, anchor);
            if (default_slot) {
...
class RuxIconNature extends SvelteComponent {
    constructor(options) {
        super();
