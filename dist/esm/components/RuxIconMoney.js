...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_money = element("rux-icon-money");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_money, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_money, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_money, anchor);
            if (default_slot) {
...
class RuxIconMoney extends SvelteComponent {
    constructor(options) {
        super();
