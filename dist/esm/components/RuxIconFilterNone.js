...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_filter_none = element("rux-icon-filter-none");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_filter_none, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_filter_none, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_filter_none, anchor);
            if (default_slot) {
...
class RuxIconFilterNone extends SvelteComponent {
    constructor(options) {
        super();
