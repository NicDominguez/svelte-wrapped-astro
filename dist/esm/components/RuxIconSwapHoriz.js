...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_swap_horiz = element("rux-icon-swap-horiz");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_swap_horiz, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_swap_horiz, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_swap_horiz, anchor);
            if (default_slot) {
...
class RuxIconSwapHoriz extends SvelteComponent {
    constructor(options) {
        super();
