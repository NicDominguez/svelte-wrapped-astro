...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_color_lens = element("rux-icon-color-lens");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_color_lens, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_color_lens, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_color_lens, anchor);
            if (default_slot) {
...
class RuxIconColorLens extends SvelteComponent {
    constructor(options) {
        super();
