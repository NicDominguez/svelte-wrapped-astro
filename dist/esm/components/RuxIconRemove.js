...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_remove = element("rux-icon-remove");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_remove, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_remove, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_remove, anchor);
            if (default_slot) {
...
class RuxIconRemove extends SvelteComponent {
    constructor(options) {
        super();
