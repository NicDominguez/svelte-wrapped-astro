...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_panorama = element("rux-icon-panorama");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_panorama, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_panorama, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_panorama, anchor);
            if (default_slot) {
...
class RuxIconPanorama extends SvelteComponent {
    constructor(options) {
        super();
