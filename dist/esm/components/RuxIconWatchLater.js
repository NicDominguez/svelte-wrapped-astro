...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_watch_later = element("rux-icon-watch-later");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_watch_later, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_watch_later, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_watch_later, anchor);
            if (default_slot) {
...
class RuxIconWatchLater extends SvelteComponent {
    constructor(options) {
        super();
