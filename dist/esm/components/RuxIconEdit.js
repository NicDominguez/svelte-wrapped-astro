...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_edit = element("rux-icon-edit");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_edit, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_edit, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_edit, anchor);
            if (default_slot) {
...
class RuxIconEdit extends SvelteComponent {
    constructor(options) {
        super();
