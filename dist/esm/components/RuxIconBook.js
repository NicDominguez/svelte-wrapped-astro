...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_book = element("rux-icon-book");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_book, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_book, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_book, anchor);
            if (default_slot) {
...
class RuxIconBook extends SvelteComponent {
    constructor(options) {
        super();
