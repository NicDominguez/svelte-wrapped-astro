...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_donut_small = element("rux-icon-donut-small");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_donut_small, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_donut_small, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_donut_small, anchor);
            if (default_slot) {
...
class RuxIconDonutSmall extends SvelteComponent {
    constructor(options) {
        super();
