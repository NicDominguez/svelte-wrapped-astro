...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_select_all = element("rux-icon-select-all");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_select_all, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_select_all, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_select_all, anchor);
            if (default_slot) {
...
class RuxIconSelectAll extends SvelteComponent {
    constructor(options) {
        super();
