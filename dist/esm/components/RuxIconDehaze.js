...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_dehaze = element("rux-icon-dehaze");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_dehaze, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_dehaze, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_dehaze, anchor);
            if (default_slot) {
...
class RuxIconDehaze extends SvelteComponent {
    constructor(options) {
        super();
