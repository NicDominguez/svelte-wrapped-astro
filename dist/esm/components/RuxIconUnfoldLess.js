...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_unfold_less = element("rux-icon-unfold-less");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_unfold_less, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_unfold_less, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_unfold_less, anchor);
            if (default_slot) {
...
class RuxIconUnfoldLess extends SvelteComponent {
    constructor(options) {
        super();
