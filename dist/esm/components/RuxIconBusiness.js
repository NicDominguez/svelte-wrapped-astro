...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_business = element("rux-icon-business");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_business, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_business, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_business, anchor);
            if (default_slot) {
...
class RuxIconBusiness extends SvelteComponent {
    constructor(options) {
        super();
