...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_toggle_off = element("rux-icon-toggle-off");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_toggle_off, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_toggle_off, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_toggle_off, anchor);
            if (default_slot) {
...
class RuxIconToggleOff extends SvelteComponent {
    constructor(options) {
        super();
