...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_menu = element("rux-icon-menu");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_menu, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_menu, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_menu, anchor);
            if (default_slot) {
...
class RuxIconMenu extends SvelteComponent {
    constructor(options) {
        super();
