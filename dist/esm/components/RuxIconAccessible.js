...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_accessible = element("rux-icon-accessible");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_accessible, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_accessible, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_accessible, anchor);
            if (default_slot) {
...
class RuxIconAccessible extends SvelteComponent {
    constructor(options) {
        super();
