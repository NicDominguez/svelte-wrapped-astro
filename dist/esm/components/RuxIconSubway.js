...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_subway = element("rux-icon-subway");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_subway, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_subway, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_subway, anchor);
            if (default_slot) {
...
class RuxIconSubway extends SvelteComponent {
    constructor(options) {
        super();
