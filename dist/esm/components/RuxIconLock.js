...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_lock = element("rux-icon-lock");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_lock, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_lock, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_lock, anchor);
            if (default_slot) {
...
class RuxIconLock extends SvelteComponent {
    constructor(options) {
        super();
