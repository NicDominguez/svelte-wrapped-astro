...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_bluetooth = element("rux-icon-bluetooth");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_bluetooth, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_bluetooth, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_bluetooth, anchor);
            if (default_slot) {
...
class RuxIconBluetooth extends SvelteComponent {
    constructor(options) {
        super();
