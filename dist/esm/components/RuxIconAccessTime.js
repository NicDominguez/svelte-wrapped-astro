...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_access_time = element("rux-icon-access-time");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_access_time, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_access_time, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_access_time, anchor);
            if (default_slot) {
...
class RuxIconAccessTime extends SvelteComponent {
    constructor(options) {
        super();
