...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_repeat = element("rux-icon-repeat");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_repeat, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_repeat, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_repeat, anchor);
            if (default_slot) {
...
class RuxIconRepeat extends SvelteComponent {
    constructor(options) {
        super();
