...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_group = element("rux-icon-group");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_group, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_group, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_group, anchor);
            if (default_slot) {
...
class RuxIconGroup extends SvelteComponent {
    constructor(options) {
        super();
