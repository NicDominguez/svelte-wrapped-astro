...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_dashboard = element("rux-icon-dashboard");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_dashboard, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_dashboard, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_dashboard, anchor);
            if (default_slot) {
...
class RuxIconDashboard extends SvelteComponent {
    constructor(options) {
        super();
