...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_view_list = element("rux-icon-view-list");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_view_list, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_view_list, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_view_list, anchor);
            if (default_slot) {
...
class RuxIconViewList extends SvelteComponent {
    constructor(options) {
        super();
