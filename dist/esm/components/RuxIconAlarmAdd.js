...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_alarm_add = element("rux-icon-alarm-add");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_alarm_add, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_alarm_add, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_alarm_add, anchor);
            if (default_slot) {
...
class RuxIconAlarmAdd extends SvelteComponent {
    constructor(options) {
        super();
