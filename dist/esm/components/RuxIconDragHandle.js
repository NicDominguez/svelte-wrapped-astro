...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_drag_handle = element("rux-icon-drag-handle");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_drag_handle, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_drag_handle, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_drag_handle, anchor);
            if (default_slot) {
...
class RuxIconDragHandle extends SvelteComponent {
    constructor(options) {
        super();
