...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_help = element("rux-icon-help");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_help, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_help, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_help, anchor);
            if (default_slot) {
...
class RuxIconHelp extends SvelteComponent {
    constructor(options) {
        super();
