...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_feedback = element("rux-icon-feedback");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_feedback, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_feedback, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_feedback, anchor);
            if (default_slot) {
...
class RuxIconFeedback extends SvelteComponent {
    constructor(options) {
        super();
