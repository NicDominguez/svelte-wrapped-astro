...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_school = element("rux-icon-school");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_school, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_school, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_school, anchor);
            if (default_slot) {
...
class RuxIconSchool extends SvelteComponent {
    constructor(options) {
        super();
