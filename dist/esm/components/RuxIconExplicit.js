...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_explicit = element("rux-icon-explicit");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_explicit, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_explicit, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_explicit, anchor);
            if (default_slot) {
...
class RuxIconExplicit extends SvelteComponent {
    constructor(options) {
        super();
