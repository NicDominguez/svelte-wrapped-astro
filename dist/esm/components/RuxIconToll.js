...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_toll = element("rux-icon-toll");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_toll, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_toll, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_toll, anchor);
            if (default_slot) {
...
class RuxIconToll extends SvelteComponent {
    constructor(options) {
        super();
