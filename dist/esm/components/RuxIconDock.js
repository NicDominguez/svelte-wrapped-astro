...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_dock = element("rux-icon-dock");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_dock, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_dock, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_dock, anchor);
            if (default_slot) {
...
class RuxIconDock extends SvelteComponent {
    constructor(options) {
        super();
