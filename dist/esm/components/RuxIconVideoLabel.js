...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_video_label = element("rux-icon-video-label");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_video_label, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_video_label, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_video_label, anchor);
            if (default_slot) {
...
class RuxIconVideoLabel extends SvelteComponent {
    constructor(options) {
        super();
