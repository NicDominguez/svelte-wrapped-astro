...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_add_comment = element("rux-icon-add-comment");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_add_comment, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_add_comment, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_add_comment, anchor);
            if (default_slot) {
...
class RuxIconAddComment extends SvelteComponent {
    constructor(options) {
        super();
