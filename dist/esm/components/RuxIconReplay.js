...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_replay = element("rux-icon-replay");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_replay, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_replay, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_replay, anchor);
            if (default_slot) {
...
class RuxIconReplay extends SvelteComponent {
    constructor(options) {
        super();
