...
function create_fragment(ctx) {
    ...
    return {
        c() {
            rux_icon_money_off = element("rux-icon-money-off");
            if (default_slot)
                default_slot.c();
            set_custom_element_data(rux_icon_money_off, "color", /*color*/ ctx[0]);
            set_custom_element_data(rux_icon_money_off, "size", /*size*/ ctx[1]);
        },
        m(target, anchor) {
            insert(target, rux_icon_money_off, anchor);
            if (default_slot) {
...
class RuxIconMoneyOff extends SvelteComponent {
    constructor(options) {
        super();
