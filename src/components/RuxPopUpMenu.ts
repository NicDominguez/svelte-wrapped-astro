...
function create_fragment(ctx) {
	...
	return {
		...
		d(detaching) {
			if (detaching) detach(rux_pop_up_menu);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ('triggerEl' in $$props) $$invalidate(3, triggerEl = $$props.triggerEl);
		if ('anchorEl' in $$props) $$invalidate(4, anchorEl = $$props.anchorEl);
