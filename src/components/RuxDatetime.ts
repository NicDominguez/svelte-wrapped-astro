...
function create_fragment(ctx) {
	...
	return {
		...
		d(detaching) {
			if (detaching) detach(rux_datetime);
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('hour' in $$props) $$invalidate(5, hour = $$props.hour);
		if ('minute' in $$props) $$invalidate(6, minute = $$props.minute);
		if ('second' in $$props) $$invalidate(7, second = $$props.second);
		if ('timeZoneName' in $$props) $$invalidate(8, timeZoneName = $$props.timeZoneName);
		if ('timeZone' in $$props) $$invalidate(9, timeZone = $$props.timeZone);
		if ('hour12' in $$props) $$invalidate(10, hour12 = $$props.hour12);
