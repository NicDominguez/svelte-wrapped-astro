...
function create_fragment(ctx) {
	...
	return {
		c() {
			rux_icon_alarm_on = element("rux-icon-alarm-on");
			if (default_slot) default_slot.c();
			set_custom_element_data(rux_icon_alarm_on, "color", /*color*/ ctx[0]);
			set_custom_element_data(rux_icon_alarm_on, "size", /*size*/ ctx[1]);
		},
		m(target, anchor) {
			insert(target, rux_icon_alarm_on, anchor);
		...
		d(detaching) {
			if (detaching) detach(rux_icon_alarm_on);
...
class RuxIconAlarmOn extends SvelteComponent {
